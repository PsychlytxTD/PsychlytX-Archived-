...
ui<- function(request) {
  sidebar <- dashboardSidebar(
    sidebarMenu(
      br(),
      menuItem(actionButton("Disclaimer", "Get Started", icon = icon("line-chart")), tabName = "PSS"),
  ...
  dashboardPage(
    dashboardHeader(title = span(tagList(tags$a(href = "http://psychlytx.com.au", "PsychlytX", style = "color: white; font-size: 26px; letter-spacing: 7.8px;font-weight: bolder;"), tags$sup("®"), "| Perceived Stress Scale - 10 (PSS-10)"), style = "color: white; letter-spacing: 1.8px;"), titleWidth = 690),
    sidebar,
    dashboardBody(
      ...
      tabItems(
        ...
        tabItem(tabName = "References", br(), 
                ...
                "Cohen, S., & Williamson, G. (1988). Perceived Stress in a Probability Sample of the United States. In S. Spacapan, & S. Oskamp (Eds.), 
                The Social Psychology of Health: Claremont Symposium on Applied Social Psychology (pp. 31-67). Newbury Park, CA: Sage.", br(), br(),
                "Cohen, S., & Janicki‐Deverts, D. (2012). Who's stressed? distributions of psychological stress in the united states in probability samples from 1983, 2006, and 2009. Journal of Applied Social Psychology, 42(6), 1320-1334.", br(), br(), 
                "Jiang, J. M., Seng, E. K., Zimmerman, M. E., Sliwinski, M., Kim, M., & Lipton, R. B. (2017). Evaluation of the reliability, validity, and predictive validity of the subscales of the perceived stress scale in older adults. Journal of Alzheimer's Disease, 59(3), 987-996.", br(), br(), 
                "Lee, E., Chung, B. Y., Suh, C., & Jung, J. (2015). Korean versions of the perceived stress scale (PSS‐14, 10 and 4): Psychometric evaluation in patients with chronic disease. Scandinavian Journal of Caring Sciences, 29(1), 183-192.", br(), br(), 
                "Lee, E. H. (2012). Review of the psychometric evidence of the perceived stress scale. Asian Nursing Research, 6(4), 121-127. doi:10.1016/j.anr.2012.08.004.", br(), br(),
                "Moore, R. C., Eyler, L. T., Mausbach, B. T., Zlatar, Z. Z., Thompson, W. K., Peavy, G., . . . Jeste, D. V. (2015). Complex interplay between health and successful aging: Role of perceived stress, resilience, and social support. The American Journal of Geriatric Psychiatry : Official Journal of the American Association for Geriatric Psychiatry, 23(6), 622-632. doi:10.1016/j.jagp.2014.08.004.", br(), br(),
                "Perera, M. J., Brintz, C. E., Birnbaum-Weitzman, O., Penedo, F. J., Gallo, L. C., Gonzalez, P., . . . Perreira, K. M. (2017). Factor structure of the perceived stress scale-10 (PSS) across english and spanish language responders in the HCHS/SOL sociocultural ancillary study. Psychological Assessment, 29(3), 320.", br(), br(), 
                  ...
                  tabBox(
                    ...
                    tabPanel("Scale",
                             wellPanel(style = "background-color: #ffffff; color: black",
                                       fluidRow(
                                         column(width = 12, offset = 4, h3(tags$strong("Perceived Stress Scale")))
                                       ),
                                       hr(),
                                       fluidRow(
                                         column(width = 12,
                                             h4(tags$strong("The questions in this scale ask you about your feelings and thoughts during the last month. 
                                       ...
                                       fluidRow(
                                         column(width = 2, offset = 1, 
                                                div(h4(tags$strong("0"), "=", "Never"))
                                         ),
                                         column(width = 2,
                                                div(h4(tags$strong("1"), "=", "Almost Never"))
                                         ),
                                         column(width = 2,
                                                div(h4(tags$strong("2"), "=", "Sometimes"))
                                         ),
                                         column(width = 2,
                                                div(h4(tags$strong("3"), "=", "Fairly Often"))
                                         ),
                                         column(width = 2,
                                                div(h4(tags$strong("4"), "=", "Very Often"))
                                         )
                                       ...
                                       fluidRow(
                                         column(width = 6, h4("1. In the last month, how often have you been upset because of something that happened unexpectedly?")),
                                         column(width = 6, radioButtons("Item_1", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("2. In the last month, how often have you felt that you were unable to control the important things in your life?")),
                                         column(width = 6, radioButtons("Item_2", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("3. In the last month, how often have you felt nervous and “stressed”?")),
                                         column(width = 6, radioButtons("Item_3", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("4. In the last month, how often have you felt confident about your ability to handle your personal problems?")),
                                         column(width = 6, radioButtons("Item_4", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("5. In the last month, how often have you felt that things were going your way?")),
                                         column(width = 6, radioButtons("Item_5", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("6. In the last month, how often have you found that you could not cope with all the things that you had to do?")),
                                         column(width = 6, radioButtons("Item_6", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("7. In the last month, how often have you been able to control irritations in your life?")),
                                         column(width = 6, radioButtons("Item_7", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("8. In the last month, how often have you felt that you were on top of things?")),
                                         column(width = 6, radioButtons("Item_8", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("9. In the last month, how often have you been angered because of things that were outside of your control?")),
                                         column(width = 6, radioButtons("Item_9", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("10. In the last month, how often have you felt difficulties were piling up so high that you could not overcome them?")),
                                       ...
                                       fluidRow(
                                         column(width = 12, "Scale Sources:")
                                       ),
                                       fluidRow(
                                         column(width = 12, h5("Cohen, S., Kamarck, T., and Mermelstein, R. (1983).  A global measure of perceived stress.  Journal of Health and Social Behavior, 24, 386-396."))
                                       ), 
                                       fluidRow(
                                         column(width = 12, h5("Cohen, S. and Williamson, G.  Perceived Stress in a Probability Sample of the United States.  Spacapan, S. and Oskamp, S. (Eds.)  The Social Psychology of Health.  Newbury Park, CA:  Sage, 1988."))
                                       )
                             )
                               ...
                               fluidRow(
                                 tabsetPanel(type = "pills",
                                             ...
                                             tabPanel("Population", width = 12,
                                                      ...
                                                      selectInput("Pop", "", choices = c("Male: General Population","Female: General Population", "Older Adult", "Chronic Illness"))
                                             ),
                                             ...
                                             tabPanel("Reliable Change Method", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 4,
                                                               selectInput("Select_CI", label = "PSS-10 total scale",
                                             ...
                                             tabPanel("Mean", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Chelune et al. (1993)' || input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)' || input.RelChangeMethod == 'Speer (1992)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Mean_1", "PSS-10 total scale", value = 0)
                                             ...
                                             tabPanel("Sd", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Sd_1", "PSS-10 total scale", value = 0)
                                                                         )))),
                                             ...
                                             tabPanel("Test-Retest Reliability", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 6,
                                                               numericInput("Reliability", "PSS-10 total scale", value = .81),
                                                               h5("Reference: Lee, Chung, Suh & Jung (2014)")
                                                        )),
                                             ...
                                             h4(tags$strong("Psychometric Properties of the PSS-10 Relevant to Assessing Reliable & Clinically Significant Change")),
...
server <- function(input, output, session) {
  ...
  CI_Vals_Reac<- reactive({
    ...
    if(input$Pop == "Male: General Population") {
      Mean_Val<<- 15.52
      Sd_Val<<- 7.44
      Source_Mean<<- "Cohen & Janicki-Deverts"
      Source_Sd<<- "Cohen & Janicki-Deverts"
      Cut_Val_1<<- Mean_Val
      ...
      Cut_Lab_2<<- "Mean + 1 Sd"
      Cut_Lab_3<<- "Mean + 2 Sd"
      Source_Cutoff_1<<- "Cohen & Janicki-Deverts"
      Source_Cutoff_2<<- "Cohen & Janicki-Deverts"
      Source_Cutoff_3<<- "Cohen & Janicki-Deverts"
      ...
      Mean_Val<<- 12.26
      Sd_Val<<-  5.41
      Source_Mean<<- "Moore, Eyler, Mausbach, Zlatar, Thompson et al (2014)"
      Source_Sd<<- "Moore, Eyler, Mausbach, Zlatar, Thompson et al (2014)"
      Cut_Val_1<<- Mean_Val
      Cut_Val_2<<- Mean_Val + Sd_Val
      Cut_Val_3<<- Mean_Val + (2*Sd_Val)
      Cut_Lab_1<<- "Mean"
      Cut_Lab_2<<- "Mean + 1 Sd"
      Cut_Lab_3<<- "Mean + 2 Sd" 
      Source_Cutoff_1<<- "Moore, Eyler, Mausbach, Zlatar, Thompson et al (2014)"
      Source_Cutoff_2<<- "Moore, Eyler, Mausbach, Zlatar, Thompson et al (2014)"
      Source_Cutoff_3<<- "Moore, Eyler, Mausbach, Zlatar, Thompson et al (2014)"
    } else if(input$Pop == "Chronic Illness") {
      Mean_Val<<- 18.11
        Sd_Val<<- 4.27
        Source_Mean<<- "Lee, Chung, Suh & Jung (2014)"
        Source_Sd<<- "Lee, Chung, Suh & Jung (2014)"
        Cut_Val_1<<- Mean_Val
        Cut_Val_2<<- Mean_Val + Sd_Val
        Cut_Val_3<<- Mean_Val + (2*Sd_Val)
        Cut_Lab_1<<- "Mean"
        Cut_Lab_2<<- "Mean + 1 Sd"
        Cut_Lab_3<<- "Mean + 2 Sd" 
        Source_Cutoff_1<<- "Lee, Chung, Suh & Jung (2014)"
        Source_Cutoff_2<<- "Lee, Chung, Suh & Jung (2014)"
        Source_Cutoff_3<<- "Lee, Chung, Suh & Jung (2014)"
    } 
  ...
  output$Mean_Widg<- renderUI({
    ...
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Mean_1", "PSS-10 total scale", Mean_Val),
  ...
  output$Sd_Widg<- renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Sd_1", "PSS-10 total scale", Sd_Val),
  ...
  output$Cutoff_Widg_1<- renderUI({ 
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_1", "PSS-10 total scale", as.numeric(Cut_Val_1)),
  ...
  output$Cutoff_Widg_2<-  renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_2", "PSS-10 total scale", as.numeric(Cut_Val_2)),
  ...
  output$Cutoff_Widg_3<-renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_3", "PSS-10 total scale", as.numeric(Cut_Val_3)),
  ...
  Entered_Scores_Reac<- reactive({
    ...
    if(input$Timepoint == "1") {
      ...
      Recode<- car::recode(Score_1a[c(4,5,7,8)],'4=0; 3=1; 2=2; 1=3; 0=4')
      Score_1a[c(4,5,7,8)]<- Recode
      ...
      Recode<- car::recode(Score_2a[c(4,5,7,8)],'4=0; 3=1; 2=2; 1=3; 0=4')
      Score_2a[c(4,5,7,8)]<- Recode
      ...
      Recode<- car::recode(Score_3a[c(4,5,7,8)],'4=0; 3=1; 2=2; 1=3; 0=4')
      Score_3a[c(4,5,7,8)]<- Recode
    ...
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] < Entered_Scores_Df$Score[1]) {
      PSS10.Fullscale.Improvement<- "Yes"
    } else if (Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] >= Entered_Scores_Df$Score[1]) {
      PSS10.Fullscale.Improvement<- "No"
    }
    
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] > Entered_Scores_Df$Score[1]) {
      PSS10.Fullscale.Deterioration<- "Yes"
    } else if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] <= Entered_Scores_Df$Score[1]) {
      PSS10.Fullscale.Deterioration<- "No"
    }
    
    
    
    PSS10.Fullscale.Change<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] - Entered_Scores_Df$Score[1]
    PSS10.Fullscale.Comparisons<- length(Entered_Scores_Df$Change) - 1
    PSS10.Fullscale.First.Date<- Entered_Scores_Df$Date[1]
    PSS10.Fullscale.Last.Date<- Entered_Scores_Df$Date[length(Entered_Scores_Df$Date)]
    PSS10.Fullscale.First.Score<- Entered_Scores_Df$Score[1]
    PSS10.Fullscale.Last.Score<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)]
    
    
    Analytics_Df<<- data.frame(PSS10.Fullscale.First.Date, PSS10.Fullscale.First.Score, PSS10.Fullscale.Comparisons, PSS10.Fullscale.Change, PSS10.Fullscale.Last.Date, PSS10.Fullscale.Last.Score, PSS10.Fullscale.Improvement,PSS10.Fullscale.Sig.Improvement, PSS10.Fullscale.Deterioration, PSS10.Fullscale.Sig.Deterioration)
  ...
  Entered_Scores_Notifications<- observeEvent(input$Action_Submit_Data, {
    ...
    if(length(Score_1a) < 10) {
      showNotification("The PSS-10 is a 10-item scale. You have entered less than 10 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(length(Score_1a) > 10) {
      showNotification("The PSS-10 is a 10-item scale. You have entered more than 10 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(input$Timepoint != "1") {
      if(length(Score_2a) < 10) {
        showNotification("The PSS-10 is a 10-item scale. You have entered less than 10 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_2a) > 10) {
        showNotification("The PSS-10 is a 10-item scale. You have entered more than 10 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
    
    if(input$Timepoint == "3") {
      if(length(Score_3a) < 10) {
        showNotification("The PSS-10 is a 10-item scale. You have entered less than 10 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_3a) > 10) {
        showNotification("The PSS-10 is a 10-item scale. You have entered more than 10 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
  ...
  output$report <- downloadHandler(
    ...
    filename = paste0(" PSS-10 ", format(Sys.time(), '%d/%m/%y'),".pdf"),
  ...
  output$Download_Export_Data <- downloadHandler(
    ...
    filename = function() {
      paste(paste0(" PSS-10 Data ", format(Sys.time(), '%d/%m/%y')), input$Output_Filetype1, sep = ".")
    },
