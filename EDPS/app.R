...
ui<- function(request) {
  sidebar <- dashboardSidebar(
    sidebarMenu(
      br(),
      menuItem(actionButton("Disclaimer", "Get Started", icon = icon("line-chart")), tabName = "EDPS"),
  ...
  dashboardPage(
    dashboardHeader(title = span(tagList(tags$a(href = "http://psychlytx.com.au", "PsychlytX", style = "color: white; font-size: 26px; letter-spacing: 7.8px;font-weight: bolder;"), tags$sup("®"), "| Edinburgh Postnatal Depression Scale (EDPS)"), style = "color: white; letter-spacing: 1.8px;"), titleWidth = 750),
    sidebar,
    dashboardBody(
      ...
      tabItems(
        ...
        tabItem(tabName = "References", br(), 
                ...
                "Carlberg, M., Edhborg, M., & Lindberg, L. (2018). Paternal perinatal depression assessed by the edinburgh postnatal depression scale and the gotland male depression scale: Prevalence and possible risk factors. American Journal of Men's Health, , 1557988317749071.", br(), br(), 
                "Cox, J. (2017). Use and Misuse of the Edinburgh Postnatal Depression Scale (EPDS): A Ten Point ‘survival Analysis’. Archives of Women's Mental Health, 20:789–790.", br(), br(),  
                "Cox, J. L., Holden, J. M., & Sagovsky, R. (1987). Detection of postnatal depression: Development of the 10-item edinburgh postnatal depression scale. The British Journal of Psychiatry, 150(6), 782-786.", br(), br(),  
                "Gibson, J., McKenzie‐McHarg, K., Shakespeare, J., Price, J., & Gray, R. (2009). A systematic review of studies validating the edinburgh postnatal depression scale in antepartum and postpartum women. Acta Psychiatrica Scandinavica, 119(5), 350-364.", br(), br(),  
                "Martin, C. R., & Redshaw, M. (2018). Establishing a coherent and replicable measurement model of the edinburgh postnatal depression scale. Psychiatry Research, 264, 182-191.", br(), br(),  
                "Matthey, S., & Agostini, F. (2017). Using the edinburgh postnatal depression scale for women and men—some cautionary thoughts. Archives of Women's Mental Health, 20(2), 345-354.", br(), br(),  
                "Matthey, S., Barnett, B., Kavanagh, D. J., & Howie, P. (2001). Validation of the edinburgh postnatal depression scale for men, and comparison of item endorsement with their partners. Journal of Affective Disorders, 64(2-3), 175-184.", br(), br(), 
                "O'CONNOR, T. G., Heron, J., Glover, V., & Alspac Study Team. (2002). Antenatal anxiety predicts child behavioral/emotional problems independently of postnatal depression. Journal of the American Academy of Child & Adolescent Psychiatry, 41(12), 1470-1477.", br(), br(),  
                "Venkatesh, K. K., Kaimal, A. J., Castro, V. M., & Perlis, R. H. (2017). Improving discrimination in antepartum depression screening using the edinburgh postnatal depression scale. Journal of Affective Disorders, 214, 1-7. doi:S0165-0327(17)30217-3."
        ),
        
        
        
        tabItem(tabName = "EDPS",
                fluidRow(
                  tabBox(
                    id = "Box",
                    width = 12,
                             ...
                             wellPanel(style = "background-color: white; color: black",
                                       ...
                                       fluidRow(
                                        column(width = 6,
                                               ...
                                               radioButtons("Item_1", "", choices = c("As much as I always could" = "0", 
                                        ...
                                        column(width = 6, h4(tags$strong("6. Things have been getting on top of me:")),
                                               radioButtons("Item_6", "", choices = c("Yes, most of the time I haven't been able to cope at all" = "3", 
                                       ...
                                       fluidRow(
                                         column(width = 6,
                                                ...
                                                radioButtons("Item_2", "", choices = c("As much as I ever did" = "0", 
                                         ...
                                         column(width = 6, h4(tags$strong("7. I have been so unhappy that I have had difficulty sleeping:")),
                                                radioButtons("Item_7", "", choices = c("Yes, most of the time" = "3", 
                                                                                       "Yes, sometimes" = "2",
                                                                                       "No, not very often" = "1",
                                       ...
                                       fluidRow(
                                         column(width = 6,
                                                ...
                                                radioButtons("Item_3", "", choices = c("Yes, most of the time" = "3",
                                                                                       "Yes, some of the time" = "2",
                                                                                       "Not very often" = "1",
                                                                                       "No, never" = "0"), inline = F, selected = character(0))
                                         ),
                                         column(width = 6, h4(tags$strong("8. I have felt sad or miserable:")),
                                                radioButtons("Item_8", "", choices = c("Yes, most of the time" = "3", 
                                                                                       "Yes, quite often" = "2",
                                                                                       "Not very often" = "1",
                                                                                       "No, not at all" = "0"), inline = F, selected = character(0))
                                         )
                                       ...
                                       fluidRow(
                                         column(width = 6,
                                                ...
                                                radioButtons("Item_4", "", choices = c("No, not at all" = "0",
                                                                                       "Hardly ever" = "1",
                                                                                       "Yes, sometimes" = "2",
                                         ...
                                         column(width = 6, h4(tags$strong("9.I have been so unhappy that I have been crying")),
                                                radioButtons("Item_9", "", choices = c("Yes, most of the time" = "3", 
                                                                                       "Yes, quite often" = "2",
                                                                                       "Only occasionally" = "1",
                                                                                       "No, never" = "0"), inline = F, selected = character(0))
                                         )
                                       ...
                                       fluidRow(
                                         column(width = 6,
                                                ...
                                                radioButtons("Item_5", "", choices = c("Yes, quite a lot" = "3",
                                                                                       "Yes, sometimes" = "2",
                                                                                       "No, not much" = "1",
                                                                                       "No, not at all" = "0"), inline = F, selected = character(0))
                                         ),
                                         column(width = 6, h4(tags$strong("10. The thought of harming myself has occurred to me:")),
                                                radioButtons("Item_10", "", choices = c("Yes, quite often" = "3", 
                                                                                       "Sometimes" = "2",
                                                                                       "Hardly ever" = "1",
                                       ...
                                       fluidRow(
                                         column(width = 12, h5("Scale Source: Cox, J.L., Holden, J.M. and Sagovsky, R. (1987). Detection of postnatal depression: development of the 10-item Edinburgh Postnatal Depression Scale, British Journal of Psychiatry, 150782-786."))
                                       )
                               ...
                               fluidRow(
                                 tabsetPanel(type = "pills",
                                             ...
                                             tabPanel("Population", width = 12,
                                                      ...
                                                      selectInput("Pop", "", choices = c("Female: Antepartum", "Female: Postpartum", "Male: Postpartum"))
                                             ),
                                             ...
                                             tabPanel("Reliable Change Method", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 4,
                                                               selectInput("Select_CI", label = "EDPS total scale",
                                             ...
                                             tabPanel("Mean", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Chelune et al. (1993)' || input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)' || input.RelChangeMethod == 'Speer (1992)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Mean_1", "EDPS total scale", value = 0)
                                             ...
                                             tabPanel("Sd", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Sd_1", "EDPS total scale", value = 0)
                                                                         )))),
                                             ...
                                             tabPanel("Test-Retest Reliability", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 6,
                                                               numericInput("Reliability", "EDPS total scale", value = .92),
                                                               h5("Reference: Kernot, Olds, Lewis & Maher (2015)")
                                                        )),
                                             ...
                                             h4(tags$strong("Psychometric Properties of the EDPS Relevant to Assessing Reliable & Clinically Significant Change")),
...
server <- function(input, output, session) {
  ...
  CI_Vals_Reac<- reactive({
    ...
    if(input$Pop == "Female: Antepartum") {
      Mean_Val<<- 3.65
      Sd_Val<<- 2.62
      Source_Mean<<- "Venkatesh, Kaimal, Castro & Perslis (2017)"
      Source_Sd<<- "Venkatesh, Kaimal, Castro & Perslis (2017)"
      Cut_Val_1<<- Mean_Val
      Cut_Val_2<<- Mean_Val + Sd_Val
      Cut_Val_3<<- 13
      Cut_Lab_1<<- "Mean"
      Cut_Lab_2<<- "Mean + 1 Sd"
      Cut_Lab_3<<- "Depression cut-off: Gibson et al. (2009)"
      Source_Cutoff_1<<- "Venkatesh, Kaimal, Castro & Perslis (2017)"
      Source_Cutoff_2<<- "Venkatesh, Kaimal, Castro & Perslis (2017)"
      Source_Cutoff_3<<- "O'Connor, Rossom, Henniger, Groom, Brittany & Burda (2015)"
    } else if(input$Pop == "Female: Postpartum") {
      Mean_Val<<- 3.77
      Sd_Val<<- 3.31
      Source_Mean<<- "Venkatesh, Kaimal, Castro & Perslis (2017)"
      Source_Sd<<- "Venkatesh, Kaimal, Castro & Perslis (2017)"
      ...
      Source_Cutoff_2<<- "Venkatesh, Kaimal, Castro & Perslis (2017)"
      Source_Cutoff_3<<- "O'Connor, Rossom, Henniger, Groom, Brittany & Burda (2015)"
    } else if(input$Pop == "Male: Postpartum"){
      Mean_Val<<- 4.35
      Sd_Val<<- 3.72
      Source_Mean<<- "Venkatesh, Kaimal, Castro & Perslis (2017)"
      Source_Sd<<- "Venkatesh, Kaimal, Castro & Perslis (2017)"
      ...
      Cut_Lab_1<<- "Mean"
      Cut_Lab_2<<- "Mean + 1 Sd"
      Cut_Lab_3<<- "Depression cut-off (Carlberg, Edhborg & Lindberg, 2018)"
      Source_Cutoff_1<<- "Venkatesh, Kaimal, Castro & Perslis (2017)"
      Source_Cutoff_2<<- "Venkatesh, Kaimal, Castro & Perslis (2017)"
      Source_Cutoff_3<<- "Carlberg, Edhborg & Lindberg (2018)"
  ...
  output$Mean_Widg<- renderUI({
    ...
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Mean_1", "EDPS total scale", Mean_Val),
  ...
  output$Sd_Widg<- renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Sd_1", "EDPS total scale", Sd_Val),
  ...
  output$Cutoff_Widg_1<- renderUI({ 
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_1", "EDPS total scale", as.numeric(Cut_Val_1)),
  ...
  output$Cutoff_Widg_2<-  renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_2", "EDPS total scale", as.numeric(Cut_Val_2)),
  ...
  output$Cutoff_Widg_3<-renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_3", "EDPS total scale", as.numeric(Cut_Val_3)),
  ...
  Entered_Scores_Reac<- reactive({
    ...
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] < Entered_Scores_Df$Score[1]) {
      EDPS.Fullscale.Improvement<- "Yes"
    } else if (Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] >= Entered_Scores_Df$Score[1]) {
      EDPS.Fullscale.Improvement<- "No"
    }
    
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] > Entered_Scores_Df$Score[1]) {
      EDPS.Fullscale.Deterioration<- "Yes"
    } else if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] <= Entered_Scores_Df$Score[1]) {
      EDPS.Fullscale.Deterioration<- "No"
    }
    
    
    
    EDPS.Fullscale.Change<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] - Entered_Scores_Df$Score[1]
    EDPS.Fullscale.Comparisons<- length(Entered_Scores_Df$Change) - 1
    EDPS.Fullscale.First.Date<- Entered_Scores_Df$Date[1]
    EDPS.Fullscale.Last.Date<- Entered_Scores_Df$Date[length(Entered_Scores_Df$Date)]
    EDPS.Fullscale.First.Score<- Entered_Scores_Df$Score[1]
    EDPS.Fullscale.Last.Score<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)]
    
    
    Analytics_Df<<- data.frame(EDPS.Fullscale.First.Date, EDPS.Fullscale.First.Score, EDPS.Fullscale.Comparisons, EDPS.Fullscale.Change, EDPS.Fullscale.Last.Date, EDPS.Fullscale.Last.Score, EDPS.Fullscale.Improvement,EDPS.Fullscale.Sig.Improvement, EDPS.Fullscale.Deterioration, EDPS.Fullscale.Sig.Deterioration)
  ...
  Entered_Scores_Notifications<- observeEvent(input$Action_Submit_Data, {
    ...
    if(length(Score_1a) < 10) {
      showNotification("The EDPS is a 10-item scale. You have entered less than 10 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(length(Score_1a) > 10) {
      showNotification("The EDPS is a 10-item scale. You have entered more than 10 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(input$Timepoint != "1") {
      if(length(Score_2a) < 10) {
        showNotification("The EDPS is a 10-item scale. You have entered less than 10 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_2a) > 10) {
        showNotification("The EDPS is a 10-item scale. You have entered more than 10 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
    
    if(input$Timepoint == "3") {
      if(length(Score_3a) < 10) {
        showNotification("The EDPS is a 10-item scale. You have entered less than 10 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_3a) > 10) {
        showNotification("The EDPS is a 10-item scale. You have entered more than 10 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
  ...
  output$report <- downloadHandler(
    ...
    filename = paste0(" EDPS Report ", format(Sys.time(), '%d/%m/%y'),".pdf"),
  ...
  output$Download_Export_Data <- downloadHandler(
    ...
    filename = function() {
      paste(paste0(" EDPS Data ", format(Sys.time(), '%d/%m/%y')), input$Output_Filetype1, sep = ".")
    },
