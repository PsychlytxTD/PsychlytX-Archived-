...
ui<- function(request) {
  sidebar <- dashboardSidebar(
    sidebarMenu(
      br(),
      menuItem(actionButton("Disclaimer", "Get Started", icon = icon("line-chart")), tabName = "PSPS"),
  ...
  dashboardPage(
    dashboardHeader(title = span(tagList(tags$a(href = "http://psychlytx.com.au", "PsychlytX", style = "color: white; font-size: 26px; letter-spacing: 7.8px;font-weight: bolder;"), tags$sup("®"), "| Pain Self-Perception Scale (PSPS)"), style = "color: white; letter-spacing: 1.8px;"), titleWidth = 615),
    sidebar,
    dashboardBody(
      ...
      tabItems(
        ...
        tabItem(tabName = "References", br(), 
                ...
                "García-Campayo, J., Rodero, B., del Hoyo, Y. L., Luciano, J., Alda, M., & Gili, M. (2010). Validation of a spanish language version of the pain self-perception scale in patients with fibromyalgia. BMC Musculoskeletal Disorders, 11(1), 255.", br(), br(), 
                "Tang, N. K., Goodchild, C. E., Hester, J., & Salkovskis, P. M. (2010). Mental defeat is linked to interference, distress and disability in chronic pain. Pain, 149(3), 547-554.", br(), br(), 
                "Tang, N. K., Beckwith, P., & Ashworth, P. (2016). Mental defeat is associated with suicide intent in patients with chronic pain. The Clinical Journal of Pain, 32(5), 411-419.", br(), br(),
                  ...
                  tabBox(
                    ...
                    tabPanel("Scale",
                             wellPanel(style = "background-color: #ffffff; color: black",
                                       fluidRow(
                                         column(width = 12, offset = 3, h3(tags$strong("Emotional Reactions to Episodes of Pain Scale")))
                                       ),
                                       fluidRow(
                                         column(width = 12,
                                                div(style = "display: inline-block;vertical-align:middle;width:300px;", h4("1. How long ago was the pain episode?")),
                                                div(style = "display: inline-block;vertical-align:middle;width:100px;", textInput("Ago", "")),
                                                div(style = "display: inline-block;vertical-align:middle;width:100px;", h4("ago"))
                                         )
                                       ),
                                       fluidRow(
                                         column(width = 12,
                                                div(style = "display: inline-block;vertical-align:middle;width:180px;", h4("2. Where was the pain?")),
                                                div(style = "display: inline-block;vertical-align:middle;width:200px;", textInput("Where", ""))
                                         )
                                       ),
                                       fluidRow(
                                         column(width = 12,
                                                div(style = "display: inline-block;vertical-align:middle;width:190px;", h4("3. What caused the pain?")),
                                                div(style = "display: inline-block;vertical-align:middle;width:200px;", textInput("Cause", ""))
                                         )
                                       ),
                                       fluidRow(
                                         column(width = 12,
                                                div(style = "display: inline-block;vertical-align:middle;width:320px;", h4("4. For how long did the pain episode last?")),
                                                div(style = "display: inline-block;vertical-align:middle;width:100px;", textInput("Duration", ""))
                                         )
                                       ),
                                       fluidRow(
                                         column(width = 12, div(h4("This questionnaire is about how you felt", tags$strong("DURING A RECENT EPISODE OF INTENSE PAIN."), "In the following, you 
                                                                   will find a number of statements that describe thoughts and feelings that people sometimes experience at a 
                                                                   time when they are in intense pain. Please rate the extent to which these statements applied to your experience", 
                                                                   tags$strong("DURING THE EPISODE OF INTENSE PAIN"), "by circling the appropriate number. There are no right or wrong answers to these 
                                                                   questions. Please remember that this questionnaire is about how you felt and thought", tags$strong("AT THE TIME OF THE INTENSE 
                                                                                                                                                                      PAIN EPISODE.")))
                                         )),
                                       ...
                                       fluidRow(
                                         column(width = 12, offset = 6,
                                                h3(tags$strong(tags$em("Thought or feeling applied to me")))
                                         )
                                       ),
                                       fluidRow(
                                         column(width = 6, h4(tags$strong("Because of the pain..."))),
                                         column(width = 1, h6(tags$strong("Not at all/never"))),
                                         column(width = 1, h6(tags$strong("Very little"))),
                                         column(width = 1, h6(tags$strong("Moderately"))),
                                         column(width = 1, h6(tags$strong("Strongly"))),
                                         column(width = 1, h6(tags$strong("Very strongly")))
                                       ),
                                       fluidRow(style = "background-color: #ededed",
                                                column(width = 6, h4("1. I felt defeated by life")),
                                                column(width = 6,radioButtons("Item_1", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("2. I felt that I had lost my standing in the world")),
                                         column(width = 6, radioButtons("Item_2", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ededed",
                                                column(width = 6, h4("3. I felt that life had treated me like a punchbag")),
                                                column(width = 6, radioButtons("Item_3", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("4. I felt powerless")),
                                         column(width = 6, radioButtons("Item_4", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ededed",
                                                column(width = 6, h4("5.  I felt that my confidence had been knocked out of me")),
                                                column(width = 6, radioButtons("Item_5", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("6. I didn’t feel able to deal with things that life threw at me’")),
                                         column(width = 6, radioButtons("Item_6", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ededed",
                                                column(width = 6, h4("7. I felt that I had sunk to the bottom of the ladder")),
                                                column(width = 6, radioButtons("Item_7", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("8. I felt completely knocked out of action")),
                                         column(width = 6, radioButtons("Item_8", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ededed",
                                                column(width = 6, h4("9. I felt that I was one of life’s losers")),
                                                column(width = 6, radioButtons("Item_9", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("10. I felt that I had given up")),
                                         column(width = 6, radioButtons("Item_10", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ededed",
                                                column(width = 6, h4("11. I felt down and out")),
                                                column(width = 6, radioButtons("Item_11", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("12. I felt I had lost important battles in life")),
                                         column(width = 6, radioButtons("Item_12", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ededed",
                                                column(width = 6, h4("13. I felt that there was no fight left in me")),
                                                column(width = 6, radioButtons("Item_13", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("14. I felt I was losing my will power")),
                                         column(width = 6, radioButtons("Item_14", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ededed",
                                                column(width = 6, h4("15. I didn’t care what happened to me anymore")),
                                                column(width = 6, radioButtons("Item_15", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("16. I felt defeated")),
                                         column(width = 6, radioButtons("Item_16", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ededed",
                                                column(width = 6, h4("17. I felt less like a human being")),
                                                column(width = 6, radioButtons("Item_17", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("18. In my mind, I gave up")),
                                         column(width = 6, radioButtons("Item_18", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ededed",
                                                column(width = 6, h4("19. I felt destroyed as a person")),
                                                column(width = 6, radioButtons("Item_19", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("20. I felt like I wanted to die")),
                                         column(width = 6, radioButtons("Item_20", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ededed",
                                                column(width = 6, h4("21. I felt like I was losing my inner resistance")),
                                                column(width = 6, radioButtons("Item_21", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("22. I felt like an object")),
                                         column(width = 6, radioButtons("Item_22", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ededed",
                                                column(width = 6, h4("23. I felt completely at the mercy of what was happening to me")),
                                                column(width = 6, radioButtons("Item_23", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("24. I felt humiliated and that I was losing my sense of inner dignity")),
                                         column(width = 6, radioButtons("Item_24", label = NULL, choices = c("0", "1", "2", "3", "4"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         hr(),
                                         fluidRow(
                                         ...
                                         fluidRow(
                                           column(width = 12, h5("Scale Source: Tang NKY, Salkovskis PM, Hanna M. Mental defeat in chronic pain: initial exploration of the concept. Clin J Pain 2007;23:222–32."))
                                         )
                                       )
                               ...
                               fluidRow(
                                 tabsetPanel(type = "pills",
                                             ...
                                             tabPanel("Population", width = 12,
                                                      ...
                                                      selectInput("Pop", "", choices = c("Chronic Pain", "Fibromyalgia"))
                                             ),
                                             ...
                                             tabPanel("Reliable Change Method", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 4,
                                                               selectInput("Select_CI", label = "PSPS total scale",
                                             ...
                                             tabPanel("Mean", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Chelune et al. (1993)' || input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)' || input.RelChangeMethod == 'Speer (1992)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Mean_1", "PSPS total scale", value = 0)
                                             ...
                                             tabPanel("Sd", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Sd_1", "PSPS total scale", value = 0)
                                                                         )))),
                                             ...
                                             tabPanel("Test-Retest Reliability", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 6,
                                                               numericInput("Reliability", "PSPS total scale", value = .92),
                                                               h5("Reference: Tang, Salkovskis & Hanna (2007)")
                                                        )),
                                             ...
                                             h4(tags$strong("Psychometric Properties of the PSPS Relevant to Assessing Reliable & Clinically Significant Change")),
...
server <- function(input, output, session) {
  ...
  observe({
    ...
    Q_Scores <- paste(input$Item_1, input$Item_2, input$Item_3, input$Item_4, input$Item_5, input$Item_6, input$Item_7, 
                      ...
                      input$Item_17, input$Item_18, input$Item_19, input$Item_20,  input$Item_21,  input$Item_22,  input$Item_23,  input$Item_24, sep = ",")
    Q_Date<- input$Q_Date
    Q_Name<- input$Q_Name
  ...
  CI_Vals_Reac<- reactive({
    ...
    if(input$Pop == "Chronic Pain") {
      Mean_Val<<- 36.2
      Sd_Val<<-28.9
      Source_Mean<<- "Tang, Salkovskis & Hanna (2007)"
      Source_Sd<<- "Tang, Salkovskis & Hanna (2007)"
      Cut_Val_1<<- 7.2
      Cut_Val_2<<- Mean_Val 
      Cut_Val_3<<- Mean_Val + Sd_Val
      Cut_Lab_1<<- "Mean (Pain-free sample)"
      Cut_Lab_2<<- "Mean (Chronic pain sample)"
      Cut_Lab_3<<- "Mean (Chronic pain sample) + 1 Sd"
      Source_Cutoff_1<<- "Tang, Salkovskis & Hanna (2007)"
      Source_Cutoff_2<<- "Tang, Salkovskis & Hanna (2007)"
      Source_Cutoff_3<<- "Tang, Salkovskis & Hanna (2007)"
    } else if(input$Pop == "Fibromyalgia") {
      Mean_Val<<-  33.4
      Sd_Val<<-  26.7
      Source_Mean<<- 
        Source_Sd<<- "Garcia-Campayo, Rodero, del Hoyo, Alda & Gili (2010)"
      Cut_Val_1<<- 7.2 
      Cut_Val_2<<- Mean_Val 
      Cut_Val_3<<- Mean_Val + Sd_Val   
      Cut_Lab_1<<-  "Mean (Pain-free sample)"
      Cut_Lab_2<<-  "Mean (Fibromyalgia sample)"
      Cut_Lab_3<<-  "Mean (Fibromyalgia sample) + 1 Sd"
      Source_Cutoff_1<<- "Tang, Salkovskis & Hanna (2007)"
      Source_Cutoff_2<<- "Garcia-Campayo, Rodero, del Hoyo, Alda & Gili (2010)"
      Source_Cutoff_3<<- "Garcia-Campayo, Rodero, del Hoyo, Alda & Gili (2010)"
    }
  ...
  output$Mean_Widg<- renderUI({
    ...
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Mean_1", "PSPS total scale", Mean_Val),
  ...
  output$Sd_Widg<- renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Sd_1", "PSPS total scale", Sd_Val),
  ...
  output$Cutoff_Widg_1<- renderUI({ 
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_1", "PSPS total scale", as.numeric(Cut_Val_1)),
  ...
  output$Cutoff_Widg_2<-  renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_2", "PSPS total scale", as.numeric(Cut_Val_2)),
  ...
  output$Cutoff_Widg_3<-renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_3", "PSPS total scale", as.numeric(Cut_Val_3)),
  ...
  Entered_Scores_Reac<- reactive({
    ...
    if(input$Timepoint == "1") {
      ...
      Recode<- car::recode(Score_1a[c(11,9,5)],'4=0; 3=1; 2=2; 1=3; 0=4')
      Score_1a[c(11,9,5)]<- Recode
      ...
      Recode<- car::recode(Score_2a[c(11,9,5)],'4=0; 3=1; 2=2; 1=3; 0=4')
      Score_2a[c(11,9,5)]<- Recode
      ...
      Recode<- car::recode(Score_3a[c(11,9,5)],'4=0; 3=1; 2=2; 1=3; 0=4')
      Score_3a[c(11,9,5)]<- Recode
    ...
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] < Entered_Scores_Df$Score[1]) {
      PSPS.Fullscale.Improvement<- "Yes"
    } else if (Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] >= Entered_Scores_Df$Score[1]) {
      PSPS.Fullscale.Improvement<- "No"
    }
    
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] > Entered_Scores_Df$Score[1]) {
      PSPS.Fullscale.Deterioration<- "Yes"
    } else if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] <= Entered_Scores_Df$Score[1]) {
      PSPS.Fullscale.Deterioration<- "No"
    }
    
    
    
    PSPS.Fullscale.Change<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] - Entered_Scores_Df$Score[1]
    PSPS.Fullscale.Comparisons<- length(Entered_Scores_Df$Change) - 1
    PSPS.Fullscale.First.Date<- Entered_Scores_Df$Date[1]
    PSPS.Fullscale.Last.Date<- Entered_Scores_Df$Date[length(Entered_Scores_Df$Date)]
    PSPS.Fullscale.First.Score<- Entered_Scores_Df$Score[1]
    PSPS.Fullscale.Last.Score<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)]
    
    
    Analytics_Df<<- data.frame(PSPS.Fullscale.First.Date, PSPS.Fullscale.First.Score, PSPS.Fullscale.Comparisons, PSPS.Fullscale.Change, PSPS.Fullscale.Last.Date, PSPS.Fullscale.Last.Score, PSPS.Fullscale.Improvement,PSPS.Fullscale.Sig.Improvement, PSPS.Fullscale.Deterioration, PSPS.Fullscale.Sig.Deterioration)
  ...
  Entered_Scores_Notifications<- observeEvent(input$Action_Submit_Data, {
    ...
    if(length(Score_1a) < 24) {
      showNotification("The PSPS is a 24-item scale. You have entered less than 24 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(length(Score_1a) > 24) {
      showNotification("The PSPS is a 24-item scale. You have entered more than 24 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(input$Timepoint != "1") {
      if(length(Score_2a) < 24) {
        showNotification("The PSPS is a 24-item scale. You have entered less than 24 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_2a) > 24) {
        showNotification("The PSPS is a 24-item scale. You have entered more than 24 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
    
    if(input$Timepoint == "3") {
      if(length(Score_3a) < 24) {
        showNotification("The PSPS is a 24-item scale. You have entered less than 24 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_3a) > 24) {
        showNotification("The PSPS is a 24-item scale. You have entered more than 24 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
  ...
  output$report <- downloadHandler(
    ...
    filename = paste0(" PSPS Report ", format(Sys.time(), '%d/%m/%y'),".pdf"),
  ...
  output$Download_Export_Data <- downloadHandler(
    ...
    filename = function() {
      paste(paste0(" PSPS Data ", format(Sys.time(), '%d/%m/%y')), input$Output_Filetype1, sep = ".")
    },
