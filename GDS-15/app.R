...
ui<- function(request) {
  sidebar <- dashboardSidebar(
    sidebarMenu(
      br(),
      menuItem(actionButton("Disclaimer", "Get Started", icon = icon("line-chart")), tabName = "GDS15"),
  ...
  dashboardPage(
    dashboardHeader(title = span(tagList(tags$a(href = "http://psychlytx.com.au", "PsychlytX", style = "color: white; font-size: 26px; letter-spacing: 7.8px;font-weight: bolder;"), tags$sup("®"), "| Geriatric Depression Scale - 15 (GDS-15)"), style = "color: white; letter-spacing: 1.8px;"), titleWidth = 750),
    sidebar,
    dashboardBody(
      ...
      tabItems(
        ...
        tabItem(tabName = "References", br(), 
                ...
                "Brown, P. J., Woods, C. M., & Storandt, M. (2007). Model stability of the 15-item geriatric depression scale across cognitive impairment and severe depression. Psychology and Aging, 22(2), 372.", br(), br(), 
                "Conradsson, M., Rosendahl, E., Littbrand, H., Gustafson, Y., Olofsson, B., & Lövheim, H. (2013). Usefulness of the geriatric depression scale 15-item version among very old people with and without cognitive impairment. Aging & Mental Health, 17(5), 638-645.", br(), br(),  
                "Friedman, B., Heisel, M. J., & Delavan, R. L. (2005). Psychometric properties of the 15‐item geriatric depression scale in functionally impaired, cognitively intact, community‐dwelling elderly primary care patients. Journal of the American Geriatrics Society, 53(9), 1570-1576.", br(), br(),  
                "Launeanu, M., & Hubley, A. M. (2012). (2012). Does the total score make sense? factor structure of the geriatric depression scale-15 (GDS-15). Paper presented at the 40th Annual Meeting of the International Neuropsychological Society (INS).", br(), br(),  
                "Mitchell, A. J., Bird, V., Rizzo, M., & Meader, N. (2010). Diagnostic validity and added value of the geriatric depression scale for depression in primary care: A meta-analysis of GDS30 and GDS15. Journal of Affective Disorders, 125(1-3), 10-17. doi:10.1016/j.jad.2009.08.019.", br(), br(), 
                "Nyunt, M. S. Z., Fones, C., Niti, M., & Ng, T. (2009). Criterion-based validity and reliability of the geriatric depression screening scale (GDS-15) in a large validation sample of community-living asian older adults. Aging and Mental Health, 13(3), 376-382.", br(), br(),  
                "Pocklington, C., Gilbody, S., Manea, L., & McMillan, D. (2016). The diagnostic accuracy of brief versions of the geriatric depression scale: A systematic review and meta‐analysis. International Journal of Geriatric Psychiatry, 31(8), 837-857.", br(), br(),  
                    ...
                    tabPanel("Scale",
                             wellPanel(style = "background-color: #ededed; color: black",
                                       ...
                                       fluidRow(
                                         ...
                                         column(width = 2, radioButtons("Item_1", label = NULL, choices = c("YES" = "0", "NO" = "1"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ffffff",
                                                column(width = 10, h4("2.	Have you dropped many of your activities and interests?")),
                                                column(width = 2, radioButtons("Item_2", label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 10, h4("3. Do you feel that your life is empty?")),
                                         column(width = 2, radioButtons("Item_3", label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ffffff",
                                                column(width = 10, h4("4. Do you often get bored?")),
                                                column(width = 2, radioButtons("Item_4", label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 10, h4("5. Are you in good spirits most of the time? ")),
                                         column(width = 2, radioButtons("Item_5", label = NULL, choices = c("YES" = "0", "NO" = "1"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ffffff",
                                                column(width = 10, h4("6.	Are you afraid that something bad is going to happen to you?")),
                                                column(width = 2, radioButtons("Item_6", label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 10, h4("7. Do you feel happy most of the time?")),
                                         column(width = 2, radioButtons("Item_7", label = NULL, choices = c("YES" = "0", "NO" = "1"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ffffff",
                                                column(width = 10, h4("8. Do you often feel helpless?")),
                                                column(width = 2, radioButtons("Item_8", label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 10, h4("9. Do you prefer to stay at home, rather than going out and doing new things?")),
                                         column(width = 2, radioButtons("Item_9", label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ffffff",
                                                column(width = 10, h4("10. Do you feel you have more problems with memory than most?")),
                                                column(width = 2, radioButtons("Item_10", label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 10, h4("11. Do you think it is wonderful to be alive now?")),
                                         column(width = 2, radioButtons("Item_11", label = NULL, choices = c("YES" = "0", "NO" = "1"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ffffff",
                                                column(width = 10, h4("12. Do you feel pretty worthless the way you are now? ")),
                                                column(width = 2, radioButtons("Item_12", label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 10, h4("13. Do you feel full of energy?")),
                                         column(width = 2, radioButtons("Item_13", label = NULL, choices = c("YES" = "0", "NO" = "1"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(style = "background-color: #ffffff",
                                                column(width = 10, h4("14. Do you feel that your situation is hopeless?")),
                                                column(width = 2, radioButtons("Item_14", label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 10, h4("15. Do you think that most people are better off than you are?")),
                                         column(width = 2, radioButtons("Item_15", label = NULL, choices = c("YES" = "1", "NO" = "0"), inline = TRUE, selected = character(0)))
                                       ),
                                       hr(),
                                       fluidRow(
                                       ...
                                       fluidRow(
                                         column(width = 12, h5("Scale Source: Sheikh, J.I., & Yesavage, J.A. (1986). Geriatric Depression Scale (GDS). Recent evidence and development of a shorter version. In T.L. Brink (Ed.), Clinical Gerontology: A Guide to Assessment and Intervention (pp. 165-173). NY: The Haworth Press, Inc."))
                                       )
                                                )),
                               ...
                               fluidRow(
                                 tabsetPanel(type = "pills",
                                             ...
                                             tabPanel("Population", width = 12,
                                                      ...
                                                      selectInput("Pop", "", choices = c("Community", "Functional Impairment", "Dementia", "Age > 85 Years"))
                                             ),
                                             ...
                                             tabPanel("Reliable Change Method", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 4,
                                                               selectInput("Select_CI", label = "GDS-15 total scale",
                                             ...
                                             tabPanel("Mean", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Chelune et al. (1993)' || input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)' || input.RelChangeMethod == 'Speer (1992)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Mean_1", "GDS-15 total scale", value = 0)
                                             ...
                                             tabPanel("Sd", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Sd_1", "GDS-15 total scale", value = 0)
                                                                         )))),
                                             ...
                                             tabPanel("Test-Retest Reliability", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 6,
                                                               numericInput("Reliability", "GDS-15 total scale", value = .83),
                                                               h5("Reference: Nyunt, Fones, Niti & Ng (2009)")
                                                        )),
                                             ...
                                             h4(tags$strong("Psychometric Properties of the GDS-15 Relevant to Assessing Reliable & Clinically Significant Change")),
...
server <- function(input, output, session) {
  ...
  CI_Vals_Reac<- reactive({
    ...
    if(input$Pop == "Functional Impairment") {
      Mean_Val<<- 4.34
      Sd_Val<<-2.98
      Source_Mean<<- "Friedman, Heisel & Delavan (2005)"
      Source_Sd<<- "Friedman, Heisel & Delavan (2005)"
      Cut_Val_1<<- Mean_Val
      Cut_Val_2<<- 6
      Cut_Val_3<<- Mean_Val + Sd_Val
      Cut_Lab_1<<- "Mean"
      Cut_Lab_2<<- "Depression Cut-Off: Pocklington et al (2016)"
      Cut_Lab_3<<- "Mean + 1 Sd"
      Source_Cutoff_1<<- "Friedman, Heisel & Delavan (2005)"
      Source_Cutoff_2<<- "Pocklington, Gilbody, Manea & McMillan (2016)"
      Source_Cutoff_3<<- "Friedman, Heisel & Delavan (2005)"
    } else if(input$Pop == "Community") {
      Mean_Val<<-  1.28
      Sd_Val<<-  1.76
      Source_Mean<<- "Knight, McMahon, Green & Skeaff (2004)"
      Source_Sd<<- "Knight, McMahon, Green & Skeaff (2004)"
      Cut_Val_1<<- Mean_Val 
      Cut_Val_2<<- 6 
      Cut_Val_3<<- Mean_Val + Sd_Val   
      Cut_Lab_1<<- "Mean"
      Cut_Lab_2<<- "Depression Cut-Off: Pocklington et al (2016)"
      Cut_Lab_3<<- "Mean + 1 Sd"
      Source_Cutoff_1<<- "Knight, McMahon, Green & Skeaff (2004)"
      Source_Cutoff_2<<- "Pocklington, Gilbody, Manea & McMillan (2016)"
      Source_Cutoff_3<<- "Knight, McMahon, Green & Skeaff (2004)"
    } else if(input$Pop == "Dementia") {
      Mean_Val<<-  3.11
      Sd_Val<<-  2.64
      Source_Mean<<- "Brown, Woods & Storandt (2007)"
      Source_Sd<<- "Brown, Woods & Storandt (2007)"
      Cut_Val_1<<- Mean_Val 
      Cut_Val_2<<- 6 
      Cut_Val_3<<- Mean_Val + Sd_Val  
      Cut_Lab_1<<- "Mean"
      Cut_Lab_2<<- "Depression Cut-Off: Pocklington et al (2016)"
      Cut_Lab_3<<- "Mean + 1 Sd"
      Source_Cutoff_1<<- "Brown, Woods & Storandt (2007)"
      Source_Cutoff_2<<- "Pocklington, Gilbody, Manea & McMillan (2016)"
      Source_Cutoff_3<<- "Brown, Woods & Storandt (2007)"
    } else if(input$Pop == " Age > 85 Years") {
      Mean_Val<<- 3.7
      Sd_Val<<- 2.6
      Source_Mean<<- "Conradsson, Rosendahl, Littbrand, Gustafson, Olofsson & Lövheim (2014)"
      Source_Sd<<- "Conradsson, Rosendahl, Littbrand, Gustafson, Olofsson & Lövheim (2014)"
      Cut_Val_1<<- Mean_Val 
      Cut_Val_2<<- 6 
      Cut_Val_3<<- Mean_Val + Sd_Val   
      Cut_Lab_1<<- "Mean"
      Cut_Lab_2<<- "Depression Cut-Off: Pocklington et al (2016)"
      Cut_Lab_3<<- "Mean + 1 Sd"
      Source_Cutoff_1<<- "Conradsson, Rosendahl, Littbrand, Gustafson, Olofsson & Lövheim (2014)"
      Source_Cutoff_2<<- "Pocklington, Gilbody, Manea & McMillan (2016)"
      Source_Cutoff_3<<- "Conradsson, Rosendahl, Littbrand, Gustafson, Olofsson & Lövheim (2014)"
    }  
  ...
  output$Mean_Widg<- renderUI({
    ...
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Mean_1", "GDS-15 total scale", Mean_Val),
  ...
  output$Sd_Widg<- renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Sd_1", "GDS-15 total scale", Sd_Val),
  ...
  output$Cutoff_Widg_1<- renderUI({ 
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_1", "GDS-15 total scale", as.numeric(Cut_Val_1)),
  ...
  output$Cutoff_Widg_2<-  renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_2", "GDS-15 total scale", as.numeric(Cut_Val_2)),
  ...
  output$Cutoff_Widg_3<-renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_3", "GDS-15 total scale", as.numeric(Cut_Val_3)),
  ...
  Entered_Scores_Reac<- reactive({
    ...
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] < Entered_Scores_Df$Score[1]) {
      GDS15.Fullscale.Improvement<- "Yes"
    } else if (Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] >= Entered_Scores_Df$Score[1]) {
      GDS15.Fullscale.Improvement<- "No"
    }
    
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] > Entered_Scores_Df$Score[1]) {
      GDS15.Fullscale.Deterioration<- "Yes"
    } else if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] <= Entered_Scores_Df$Score[1]) {
      GDS15.Fullscale.Deterioration<- "No"
    }
    
    
    
    GDS15.Fullscale.Change<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] - Entered_Scores_Df$Score[1]
    GDS15.Fullscale.Comparisons<- length(Entered_Scores_Df$Change) - 1
    GDS15.Fullscale.First.Date<- Entered_Scores_Df$Date[1]
    GDS15.Fullscale.Last.Date<- Entered_Scores_Df$Date[length(Entered_Scores_Df$Date)]
    GDS15.Fullscale.First.Score<- Entered_Scores_Df$Score[1]
    GDS15.Fullscale.Last.Score<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)]
    
    
    Analytics_Df<<- data.frame(GDS15.Fullscale.First.Date, GDS15.Fullscale.First.Score, GDS15.Fullscale.Comparisons, GDS15.Fullscale.Change, GDS15.Fullscale.Last.Date, GDS15.Fullscale.Last.Score, GDS15.Fullscale.Improvement,GDS15.Fullscale.Sig.Improvement, GDS15.Fullscale.Deterioration, GDS15.Fullscale.Sig.Deterioration)
  ...
  Entered_Scores_Notifications<- observeEvent(input$Action_Submit_Data, {
    ...
    if(length(Score_1a) < 15) {
      showNotification("The GDS-15 is a 15-item scale. You have entered less than 15 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(length(Score_1a) > 15) {
      showNotification("The GDS-15 is a 15-item scale. You have entered more than 15 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(input$Timepoint != "1") {
      if(length(Score_2a) < 15) {
        showNotification("The GDS-15 is a 15-item scale. You have entered less than 15 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_2a) > 15) {
        showNotification("The GDS-15 is a 15-item scale. You have entered more than 15 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
    
    if(input$Timepoint == "3") {
      if(length(Score_3a) < 15) {
        showNotification("The GDS-15 is a 15-item scale. You have entered less than 15 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_3a) > 15) {
        showNotification("The GDS-15 is a 15-item scale. You have entered more than 15 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
  ...
  output$report <- downloadHandler(
    ...
    filename = paste0(" GDS-15 Report ", format(Sys.time(), '%d/%m/%y'),".pdf"),
  ...
  output$Download_Export_Data <- downloadHandler(
    ...
    filename = function() {
      paste(paste0(" GDS-15 Data ", format(Sys.time(), '%d/%m/%y')), input$Output_Filetype1, sep = ".")
    },
