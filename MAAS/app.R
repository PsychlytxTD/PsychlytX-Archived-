...
ui<- function(request) {
  sidebar <- dashboardSidebar(
    sidebarMenu(
      br(),
      menuItem(actionButton("Disclaimer", "Get Started", icon = icon("line-chart")), tabName = "MAAS"),
  ...
  dashboardPage(
    dashboardHeader(title = span(tagList(tags$a(href = "http://psychlytx.com.au", "PsychlytX", style = "color: white; font-size: 26px; letter-spacing: 7.8px;font-weight: bolder;"), tags$sup("®"), "| Mindful Attention Awareness Scale (MAAS)"), style = "color: white; letter-spacing: 1.8px;"), titleWidth = 750),
    sidebar,
    dashboardBody(
      ...
      tabItems(
        ...
        tabItem(tabName = "References", br(), 
                ...
                h4("Brown, K. W., & Ryan, R. M. (2003). The benefits of being present: Mindfulness and its role in psychological well-being. Journal of Personality and Social Psychology, 84(4), 822-848"), br(), br(), 
                h4("Brown, K. W., West, A. M., Loverich, T. M., & Biegel, G. M. (2011). Assessing adolescent mindfulness: Validation of an adapted mindful attention awareness scale in adolescent normative and psychiatric populations. Psychological Assessment, 23(4), 1023"), br(), br(),
                h4("Torrence, N. (2015). The psychometric properties of the mindful attention awareness scale and its relationship with cognitive functioning in older adults University of Colorado at Colorado Springs."), br(), br(),
                h4("Brown. Open letter providing permission to use the MAAS (available at http://www.kirkwarrenbrown.vcu.edu/wp-content/scales/MAAS%20trait%20research-ready%20+%20intro.pdf).")
                  ...
                  tabBox(
                    ...
                    tabPanel("Scale",
                             wellPanel(style = "background-color: #ffffff; color: black",
                                       fluidRow(
                                         column(width = 12, offset = 4, h3(tags$strong("Day-to-Day Experiences"))), br(),
                                         column(width = 12, h4(tags$strong("Instructions: Below is a collection of statements about your 
                                                                           everyday experience. Using the 1-6 scale below, please indicate 
                                                                           how frequently or infrequently you currently have each experience. 
                                                                           Please answer according to what really reflects your experience rather
                                                                           than what you think your experience should be. Please treat each item 
                                       ...
                                       fluidRow(
                                         column(width = 1, h4("Almost Always")),
                                         column(width = 1),
                                         column(width = 1, h4("Very Frequently")),
                                         column(width = 1),
                                         column(width = 1, h4("Somewhat Frequently")),
                                         column(width = 1),
                                         column(width = 1, h4("Somewhat Infrequently")),
                                         column(width = 1),
                                         column(width = 1, h4("Very Infrequently")),
                                         column(width = 1),
                                         column(width = 1, h4("Almost Never"))
                                       ),
                                       
                                       hr(),
                                       
                                       fluidRow(
                                         column(width = 6, h4("I could be experiencing some emotion and not be conscious of it until some time later.")),
                                         column(width = 6,radioButtons("Item_1", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I break or spill things because of carelessness, not paying attention, or thinking of something else.")),
                                         column(width = 6, radioButtons("Item_2", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I find it difficult to stay focused on what’s happening in the present.")),
                                         column(width = 6, radioButtons("Item_3", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I tend to walk quickly to get where I’m going without paying attention to what I experience along the way.")),
                                         column(width = 6, radioButtons("Item_4", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I tend not to notice feelings of physical tension or discomfort until they really grab my attention.")),
                                         column(width = 6, radioButtons("Item_5", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I forget a person’s name almost as soon as I’ve been told it for the first time.")),
                                         column(width = 6, radioButtons("Item_6", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("It seems I am “running on automatic,” without much awareness of what I’m doing.")),
                                         column(width = 6, radioButtons("Item_7", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I rush through activities without being really attentive to them.")),
                                         column(width = 6, radioButtons("Item_8", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I get so focused on the goal I want to achieve that I lose touch with what I’m doing right now to get there.")),
                                         column(width = 6, radioButtons("Item_9", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I do jobs or tasks automatically, without being aware of what I'm doing.")),
                                         column(width = 6, radioButtons("Item_10", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I find myself listening to someone with one ear, doing something else at the same time.")),
                                         column(width = 6, radioButtons("Item_11", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I drive places on ‘automatic pilot’ and then wonder why I went there.")),
                                         column(width = 6, radioButtons("Item_12", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I find myself preoccupied with the future or the past.")),
                                         column(width = 6, radioButtons("Item_13", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I find myself doing things without paying attention.")),
                                         column(width = 6, radioButtons("Item_14", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       fluidRow(
                                         column(width = 6, h4("I snack without being aware that I’m eating.")),
                                         column(width = 6, radioButtons("Item_15", label = NULL, choices = c("1", "2", "3", "4", "5", "6"), inline = TRUE, selected = character(0)))
                                       ),
                                       ...
                                       fluidRow(
                                         ...
                                         fluidRow(
                                           column(width = 12, h5("Scale Source: Brown, K.W. & Ryan, R.M. (2003). The benefits of being present: Mindfulness and its role in psychological well-being. Journal of Personality and Social Psychology, 84, 822-848."))
                                         )
                                       )
                               ...
                               fluidRow(
                                 tabsetPanel(type = "pills",
                                             ...
                                             tabPanel("Population", width = 12,
                                                      ...
                                                      selectInput("Pop", "", choices = c("Community Sample", "University Student", "Psychiatric Outpatient (Adolescent)", "Older Adult"))
                                             ),
                                             ...
                                             tabPanel("Reliable Change Method", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 4,
                                                               selectInput("Select_CI", label = "MAAS total scale",
                                             ...
                                             tabPanel("Mean", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Chelune et al. (1993)' || input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)' || input.RelChangeMethod == 'Speer (1992)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Mean_1", "MAAS total scale", value = 0)
                                             ...
                                             tabPanel("Sd", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Sd_1", "MAAS total scale", value = 0)
                                                                         )))),
                                             ...
                                             tabPanel("Test-Retest Reliability", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 6,
                                                               numericInput("Reliability", "MAAS total scale", value = .86),
                                                               h5("Reference: Torrence (2015)")
                                                        )),
                                             ...
                                             h4(tags$strong("Psychometric Properties of the MAAS Relevant to Assessing Reliable & Clinically Significant Change")),
...
server <- function(input, output, session) {
  ...
  observe({
    ...
    Q_Scores <- paste(input$Item_1, input$Item_2, input$Item_3, input$Item_4, input$Item_5, input$Item_6, input$Item_7, 
                      input$Item_8, input$Item_9, input$Item_10, input$Item_11,  input$Item_12, input$Item_13, input$Item_14, input$Item_15, sep = ",")
    Q_Date<- input$Q_Date
    Q_Name<- input$Q_Name
  ...
  CI_Vals_Reac<- reactive({
    ...
    if(input$Pop == "Community Sample") {
      Mean_Val<<- 4.2
      Sd_Val<<- 0.69
      Source_Mean<<- "Brown & Ryan (2003)"
      Source_Sd<<- "Brown & Ryan (2003)"
        Cut_Val_1<<- Mean_Val
        ...
        Cut_Lab_2<<- "Mean + 1 Sd"
        Cut_Lab_3<<- "Mean + 2 Sd"
        Source_Cutoff_1<<- "Brown & Ryan (2003)"
        Source_Cutoff_2<<- "Brown & Ryan (2003)"
        Source_Cutoff_3<<- "Brown & Ryan (2003)"
      ...
      Source_Cutoff_2<<- "Brown & Ryan (2003)"
      Source_Cutoff_3<<- "Brown & Ryan (2003)"
    } else if(input$Pop == "Psychiatric Outpatient (Adolescent)") {
      Mean_Val<<- 3.31
      Sd_Val<<-  0.78
      Source_Mean<<- "Brown, West, Loverich & Biegel (2011)"
      Source_Sd<<- "Brown, West, Loverich & Biegel (2011)"
      Cut_Val_1<<- Mean_Val
      Cut_Val_2<<- Mean_Val + Sd_Val
      Cut_Val_3<<- Mean_Val + (2*Sd_Val)
      Cut_Lab_1<<- "Mean"
      Cut_Lab_2<<- "Mean + 1 Sd"
      Cut_Lab_3<<- "Mean + 2 Sd"
      Source_Cutoff_1<<- "Brown, West, Loverich & Biegel (2011)"
      Source_Cutoff_2<<- "Brown, West, Loverich & Biegel (2011)"
      Source_Cutoff_3<<- "Brown, West, Loverich & Biegel (2011)"
    } else if(input$Pop == "Older Adult") {
      Mean_Val<<- 4.38
        Sd_Val<<- 0.75
        Source_Mean<<- "Torrence (2015)"
        Source_Sd<<- "Torrence (2015)"
        Cut_Val_1<<- Mean_Val
        Cut_Val_2<<- Mean_Val + Sd_Val
        Cut_Val_3<<- Mean_Val + (2*Sd_Val)
        Cut_Lab_1<<- "Mean"
        Cut_Lab_2<<- "Mean + 1 Sd"
        Cut_Lab_3<<- "Mean + 2 Sd"
        Source_Cutoff_1<<- "Torrence (2015)"
        Source_Cutoff_2<<- "Torrence (2015)"
        Source_Cutoff_3<<- "Torrence (2015)"
    } 
  ...
  output$Mean_Widg<- renderUI({
    ...
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Mean_1", "MAAS total scale", Mean_Val),
  ...
  output$Sd_Widg<- renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Sd_1", "MAAS total scale", Sd_Val),
  ...
  output$Cutoff_Widg_1<- renderUI({ 
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_1", "MAAS total scale", as.numeric(Cut_Val_1)),
  ...
  output$Cutoff_Widg_2<-  renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_2", "MAAS total scale", as.numeric(Cut_Val_2)),
  ...
  output$Cutoff_Widg_3<-renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_3", "MAAS total scale", as.numeric(Cut_Val_3)),
  ...
  Entered_Scores_Reac<- reactive({
    ...
    if(input$Timepoint == "1") {
      ...
      Item_Df<<- data.frame(Item = 1:15, Score = Score_1a)
      Score<- mean(Score_1a, na.rm = TRUE)
      ...
      Date<- format(as.Date(Date), "%d/%m/%Y")
      Score_1a<<- as.numeric(unlist(strsplit(input$Text_1,",")))
      Score_1<- mean(Score_1a, na.rm = TRUE)
      Score_2a<<- as.numeric(unlist(strsplit(input$Text_2,",")))
      Item_Df<<- data.frame(Item = 1:15, Score = Score_2a)
      Score_2<- mean(Score_2a, na.rm = TRUE)
      ...
      Item_Df<<- data.frame(Item = 1:15, Score = Score_3a)
      Score_3<- mean(Score_3a, na.rm = TRUE)
    ...
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] < Entered_Scores_Df$Score[1]) {
      MAAS.Fullscale.Improvement<- "Yes"
    } else if (Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] >= Entered_Scores_Df$Score[1]) {
      MAAS.Fullscale.Improvement<- "No"
    }
    
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] > Entered_Scores_Df$Score[1]) {
      MAAS.Fullscale.Deterioration<- "Yes"
    } else if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] <= Entered_Scores_Df$Score[1]) {
      MAAS.Fullscale.Deterioration<- "No"
    }
    
    
    
    MAAS.Fullscale.Change<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] - Entered_Scores_Df$Score[1]
    MAAS.Fullscale.Comparisons<- length(Entered_Scores_Df$Change) - 1
    MAAS.Fullscale.First.Date<- Entered_Scores_Df$Date[1]
    MAAS.Fullscale.Last.Date<- Entered_Scores_Df$Date[length(Entered_Scores_Df$Date)]
    MAAS.Fullscale.First.Score<- Entered_Scores_Df$Score[1]
    MAAS.Fullscale.Last.Score<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)]
    
    
    Analytics_Df<<- data.frame(MAAS.Fullscale.First.Date, MAAS.Fullscale.First.Score, MAAS.Fullscale.Comparisons, MAAS.Fullscale.Change, MAAS.Fullscale.Last.Date, MAAS.Fullscale.Last.Score, MAAS.Fullscale.Improvement,MAAS.Fullscale.Sig.Improvement, MAAS.Fullscale.Deterioration, MAAS.Fullscale.Sig.Deterioration)
  ...
  Entered_Scores_Notifications<- observeEvent(input$Action_Submit_Data, {
    ...
    if(length(Score_1a) < 15) {
      showNotification("The MAAS is a 15-item scale. You have entered less than 15 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(length(Score_1a) > 15) {
      showNotification("The MAAS is a 15-item scale. You have entered more than 15 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(input$Timepoint != "1") {
      if(length(Score_2a) < 15) {
        showNotification("The MAAS is a 15-item scale. You have entered less than 15 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_2a) > 15) {
        showNotification("The MAAS is a 15-item scale. You have entered more than 15 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
    
    if(input$Timepoint == "3") {
      if(length(Score_3a) < 15) {
        showNotification("The MAAS is a 15-item scale. You have entered less than 15 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_3a) > 15) {
        showNotification("The MAAS is a 15-item scale. You have entered more than 15 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
  ...
  output$report <- downloadHandler(
    ...
    filename = paste0(" MAAS Report ", format(Sys.time(), '%d/%m/%y'),".pdf"),
  ...
  output$Download_Export_Data <- downloadHandler(
    ...
    filename = function() {
      paste(paste0(" MAAS Data ", format(Sys.time(), '%d/%m/%y')), input$Output_Filetype1, sep = ".")
    },
