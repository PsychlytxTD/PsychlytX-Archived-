...
ui<- function(request) {
  sidebar <- dashboardSidebar(
    sidebarMenu(
      br(),
      menuItem(actionButton("Disclaimer", "Get Started", icon = icon("line-chart")), tabName = "PQ_B"),
  ...
  dashboardPage(
    dashboardHeader(title = span(tagList(tags$a(href = "http://psychlytx.com.au", "PsychlytX", style = "color: white; font-size: 26px; letter-spacing: 7.8px;font-weight: bolder;"), tags$sup("®"), "| Prodromal Questionnaire - Brief (PQ-B)"), style = "color: white; letter-spacing: 1.8px;"), titleWidth = 650),
    sidebar,
    dashboardBody(
      ...
      tabItems(
        ...
        tabItem(tabName = "References", br(), 
                ...
                "Fonseca-Pedrero, E., Gooding, D. C., Ortuno-Sierra, J., Pflum, M., Paino, M., & Muniz, J. (2016). Classifying risk status of non-clinical adolescents using psychometric indicators for psychosis spectrum disorders. Psychiatry Research, 243, 246-254. doi:10.1016/j.psychres.2016.06.049", br(), br(), 
                "Hanssen, M., Peeters, F., Krabbendam, L., Radstake, S., Verdoux, H., & Van Os, J. (2003). How psychotic are individuals with non-psychotic disorders? Social Psychiatry and Psychiatric Epidemiology, 38(3), 149-154.", br(), br(),  
                "Kline, E., Thompson, E., Bussell, K., Pitts, S. C., Reeves, G., & Schiffman, J. (2014). Psychosis-like experiences and distress among adolescents using mental health services. Schizophrenia Research, 152(2-3), 498-502. doi:10.1016/j.schres.2013.12.012", br(), br(),  
                "Kline, E., Thompson, E., Demro, C., Bussell, K., Reeves, G., & Schiffman, J. (2015). Longitudinal validation of psychosis risk screening tools. Schizophrenia Research, 165(2-3), 116-122. doi:10.1016/j.schres.2015.04.026", br(), br(), 
                "Kline, E., Wilson, C., Ereshefsky, S., Tsuji, T., Schiffman, J., Pitts, S., & Reeves, G. (2012). Convergent and discriminant validity of attenuated psychosis screening tools. Schizophrenia Research, 134(1), 49-53. doi:10.1016/j.schres.2011.10.001", br(), br(),  
                "Loewy, R. L., Pearson, R., Vinogradov, S., Bearden, C. E., & Cannon, T. D. (2011). Psychosis risk screening with the prodromal questionnaire--brief version (PQ-B). Schizophrenia Research, 129(1), 42-46. doi:10.1016/j.schres.2011.03.029" 
  
        ),
        
        
        
        tabItem(tabName = "PQ_B",
                fluidRow(
                  tabBox(
                    id = "Box",
                    width = 12,
                    tabPanel("Scale",
                             wellPanel(style = "background-color: #ededed; color: black",
                               ...
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_1", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_1", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE))
                                       ), br(),
                               h4(tags$strong("2. Have you heard unusual sounds like banging, clicking, hissing, clapping or ringing in your ears?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_2", "", choices = c("YES" = "1", "NO" = "0"),  inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_2", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               ...
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_3", "", choices = c("YES" = "1", "NO" = "0"),  inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_3", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("4. Have you had experiences with telepathy, psychic forces, or fortune telling?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_4", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_4", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("5. Have you felt that you are not in control of your own ideas or thoughts?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_5", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_5", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               ...
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_6", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_6", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("7. Do you have strong feelings or beliefs about being unusually gifted or talented in some way?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_7", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_7", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("8. Do you feel that other people are watching you or talking about you?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_8", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_8", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("9. Do you sometimes get strange feelings on or just beneath your skin, like bugs crawling?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_9", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_9", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("10. Do you sometimes feel suddenly distracted by distant sounds that you are not normally aware of?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_10", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_10", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("11. Have you had the sense that some person or force is around you, although you couldn’t see anyone?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_11", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_11", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("12. Do you worry at times that something may be wrong with your mind?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_12", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_12", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("13. Have you ever felt that you don't exist, the world does not exist, or that you are dead?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_13", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_13", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("14. Have you been confused at times whether something you experienced was real or imaginary?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_14", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_14", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("15. Do you hold beliefs that other people would find unusual or bizarre?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_15", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_15", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               ...
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_16", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_16", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("17. Are your thoughts sometimes so strong that you can almost hear them?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_17", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_17", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("18. Do you find yourself feeling mistrustful or suspicious of other people?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_18", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_18", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("19. Have you seen unusual things like flashes, flames, blinding light, or geometric figures?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_19", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_19", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("20. Have you seen things that other people can't see or don't seem to see?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_20", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_20", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ), br(),
                               h4(tags$strong("21. Do people sometimes find it hard to understand what you are saying?")), 
                               fluidRow(
                                 column(width = 2, checkboxGroupInput("Item_21", "", choices = c("YES" = "1", "NO" = "0"), inline = TRUE)),
                                 column(width = 10, br(), div(h4(tags$strong("If YES:"), "When this happens, I feel frightened, concerned, or it causes problems for me:")),
                                        checkboxGroupInput("D_Item_21", "", choices = c("Strongly disagree" = "1", "disagree" = "2", "neutral" = "3", "agree" = "4", "strongly agree" = "5"), inline = TRUE, selected = character(0)))
                               ),
                               hr(),
                               fluidRow(
                    ...
                    tabPanel("Enter Data",
                             fluidRow(
                               column(width = 12,
                                      titlePanel(span(tagList(icon("edit", lib = "font-awesome")), h4(tags$b("Enter Scores for Each Timepoint")),
                                                      tags$ul(
                                                        tags$li(helpText(h5(tags$em(tags$b("Use commas to separate scores. Enter scores for all Psychosis-Like Experience (PLE) items in the top field.", style = "color:black"))))),
                                                        tags$li(helpText(h5(tags$em(tags$b("Then enter scores for distress items in the field beneath. If the patient did not endorse a particular PLE item, enter a distress score of 0 for that item.", style = "color:black")))))
                                                      )
                                      ))
                               )
                             ),
                             ...
                             fluidRow(
                               ...
                               column(4,
                                      textInput('Text_1', 'Time 1 Item Scores', "0,1,0,1,etc"),
                                      textInput('Text_1_Distress', "Time 1 Distress Scores", "0,1,2,3,4,5,etc."),
                                      hr(),
                                      textInput('Text_2', 'Time 2 Item Scores', "0,1,0,1,etc"),
                                      textInput('Text_2_Distress', "Time 2 Distress Scores", "0,1,2,3,4,5,etc."),
                                      hr(),
                                      textInput('Text_3', 'Time 3 Item Scores', "0,1,0,1,etc"),
                                      textInput('Text_3_Distress', "Time 3 Distress Scores", "0,1,2,3,4,5,etc.")
                             ...
                             fluidRow(
                               column(width = 12, h5("Scale Source: Loewy, RL & Cannon, TD. (2010). The Prodromal Questionnaire, Brief Version (PQ-B). University of California."))
                             )
                             ),
                               ...
                               fluidRow(
                                 tabsetPanel(type = "pills",
                                             ...
                                             tabPanel("Population", width = 12,
                                                      ...
                                                      selectInput("Pop", "", choices = c("Adolescent/Young Adult"))
                                             ),
                                             ...
                                             tabPanel("Reliable Change Method", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 2,
                                                               selectInput("Select_CI", label = "PQ_B total scale",
                                             ...
                                             tabPanel("Mean", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Chelune et al. (1993)' || input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)' || input.RelChangeMethod == 'Speer (1992)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 2,
                                                                                numericInput("Retest_Mean", "PQ_B total scale", value = 0)
                                                                         )
                                                                       )
                                             ...
                                             tabPanel("Sd", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 2,
                                                                                numericInput("Retest_Sd", "PQ_B total scale", value = 0)
                                                                         )
                                                                       )
                                             ...
                                             tabPanel("Test-Retest Reliability", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 2,
                                                               numericInput("Reliability", "PQ-B total scale", value = .81),
                                                               h6("Kline, Wilson, Ereshefsky, Tsuji, Schiffman, Pitts & Reeves (2012)")
                                                        )
                                             ...
                                             tabPanel("User-Defined Cut-Off Scores", width = 12,
                                                      ...
                                                      fluidRow(
                                                        ...
                                                        column(width = 2,
                                                               uiOutput("Cutoff_Widg_Distress_1") 
                                                        )
                                                      ...
                                                      fluidRow(
                                                        ...
                                                        column(width = 2,
                                                               uiOutput("Cutoff_Widg_Distress_2") 
                                                        )
                                                      ...
                                                      fluidRow(
                                                        ...
                                                        column(width = 2,
                                                               uiOutput("Cutoff_Widg_Distress_3") 
                                                        )
                                             ...
                                             h4(tags$strong("Psychometric Properties of the PQ_B Relevant to Assessing Reliable & Clinically Significant Change")),
                             ...
                             fluidPage(
                               ...
                               sidebarLayout(position = "right",
                                             sidebarPanel(width = 5,
                                                          ...
                                                          selectInput("Dropout", "Early Dropout", c("", "YES" = "1", "NO" = "0"), width = '200px'),
                                                          hr(),
...
server <- function(input, output, session) {
  ...
  observe({
    ...
    Q_Scores <- paste(input$Item_1, input$Item_2, input$Item_3, input$Item_4, input$Item_5, input$Item_6, input$Item_7, 
                      ...
                      input$Item_15, input$Item_16, input$Item_17, input$Item_18, input$Item_19, input$Item_20, input$Item_21, sep = ",")
    
    Q_Scores_Distress<- paste(input$D_Item_1, input$D_Item_2, input$D_Item_3, input$D_Item_4, input$D_Item_5, input$D_Item_6, input$D_Item_7, 
                              input$D_Item_8, input$D_Item_9, input$D_Item_10, input$D_Item_11, input$D_Item_12, input$D_Item_13, input$D_Item_14,
                              input$D_Item_15, input$D_Item_16, input$D_Item_17, input$D_Item_18, input$D_Item_19, input$D_Item_20, input$D_Item_21, sep = ",")
    ...
    updateTextInput(session, "Text_1_Distress", value = Q_Scores_Distress)
  ...
  CI_Vals_Reac<- reactive({
    ...
    if(input$Pop == "Adolescent/Young Adult") {
      Mean_Val<<- 5.26
      Sd_Val<<-4.39
      Source_Mean<<- "Fonseca-Pedrero, Gooding, Ortuño-Sierra, Pflum, Paino & Muñiz (2016)"
      Source_Sd<<- "Fonseca-Pedrero, Gooding, Ortuño-Sierra, Pflum, Paino & Muñiz (2016)"
      Cut_Val_1<<- Mean_Val
      Cut_Val_2<<- 9
      Cut_Val_3<<- Mean_Val + (2*Sd_Val)
      Cut_Lab_1<<- "Mean (Adolescent/Young Adult Sample)"
      Cut_Lab_2<<- "CHR Status Cut-off (Kline et al., 2014)"
      Cut_Lab_3<<- "Mean (Adolescent/Young Adult Sample) + 2 Sd"
      Source_Cutoff_1<<- "Fonseca-Pedrero, Gooding, Ortuño-Sierra, Pflum, Paino & Muñiz (2016)"
      Source_Cutoff_2<<- "Kline, Thompson, Pitts, Reeves & Schiffman (2014)"
      Source_Cutoff_3<<- "Fonseca-Pedrero, Gooding, Ortuño-Sierra, Pflum, Paino & Muñiz (2016)"
      Mean_Val_Distress<<- 14.04
      Sd_Val_Distress<<-13.74
      Source_Mean_Distress<<- "Fonseca-Pedrero, Gooding, Ortuño-Sierra, Pflum, Paino & Muñiz (2016)"
      Source_Sd_Distress<<- "Fonseca-Pedrero, Gooding, Ortuño-Sierra, Pflum, Paino & Muñiz (2016)"
      Cut_Val_Distress_1<<- 6
      Cut_Val_Distress_2<<- Mean_Val_Distress 
      Cut_Val_Distress_3<<- 18
      Cut_Lab_1_Distress<<- "UHR/Psychotic Syndrome Cut-Off (Loewy et al., 2011)"
      Cut_Lab_2_Distress<<- "Mean (Adolescent/Young Adult Sample)"
      Cut_Lab_3_Distress<<- "CHR Status Cut-Off (Kline et al., 2014)"
      Source_Cutoff_Distress_1<<- "Loewy, Pearson, Vinogradov, Bearden & Cannon (2011)"
      Source_Cutoff_Distress_2<<- "Fonseca-Pedrero, Gooding, Ortuño-Sierra, Pflum, Paino & Muñiz (2016)"
      Source_Cutoff_Distress_3<<- "Kline, Thompson, Pitts, Reeves & Schiffman (2014)"
    }  
  ...
  output$Mean_Widg<- renderUI({
    ...
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Mean", "PQ-B total scale", Mean_Val),
  ...
  output$Sd_Widg<- renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Sd", "PQ-B total scale", Sd_Val),
  ...
  output$Cutoff_Widg_1<- renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_1", "PQ-B total scale", as.numeric(Cut_Val_1)),
  ...
  output$Cutoff_Widg_Distress_1<- renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_Distress_1", "Distress", as.numeric(Cut_Val_Distress_1)),
      textInput("Cutoff_Text_Distress_1", "Cut-Off Score Name", Cut_Lab_1_Distress),
      h6(paste("Reference:", Source_Cutoff_Distress_1))
    )
  })
  outputOptions(output, "Cutoff_Widg_Distress_1", suspendWhenHidden = FALSE)
  

  output$Cutoff_Widg_2<-  renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_2", "PQ-B total scale", as.numeric(Cut_Val_2)),
  ...
  output$Cutoff_Widg_Distress_2<-  renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_Distress_2", "Distress", as.numeric(Cut_Val_Distress_2)),
      textInput("Cutoff_Text_Distress_2", "Cut-Off Score Name", Cut_Lab_2_Distress),
      h6(paste("Reference:", Source_Cutoff_Distress_2))
    )
  })
  outputOptions(output, "Cutoff_Widg_Distress_2", suspendWhenHidden = FALSE)
  ...
  output$Cutoff_Widg_3<-renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_3", "PQ-B total scale", as.numeric(Cut_Val_3)),
  ...
  output$Cutoff_Widg_Distress_3<-renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_Distress_3", "Distress", as.numeric(Cut_Val_Distress_3)),
      textInput("Cutoff_Text_Distress_3", "Cut-Off Score Name", Cut_Lab_3_Distress),
      h6(paste("Reference:", Source_Cutoff_Distress_3))
    )
  })
  outputOptions(output, "Cutoff_Widg_Distress_3", suspendWhenHidden = FALSE)
  ...
  Entered_Scores_Reac<- reactive({
    ...
    Cutoff_Name_Distress_1<- input$Cutoff_Text_Distress_1
    Cutoff_Name_Distress_2<- input$Cutoff_Text_Distress_2
    Cutoff_Name_Distress_3<- input$Cutoff_Text_Distress_3
    Cutoff_Names<<- data.frame(Cutoff_Name_1,Cutoff_Name_2,Cutoff_Name_3,Cutoff_Name_Distress_1,Cutoff_Name_Distress_2,Cutoff_Name_Distress_3)
    ...
    if(input$Timepoint == "1") {
      ...
      Score_1b<<-as.numeric(unlist(stri_split_fixed(input$Text_1_Distress,",", omit_empty = FALSE))) 
      Item_Df<<- data.frame(Item = 1:length(Score_1a), Score = Score_1a, Distress = Score_1b)
      Score<- sum(Score_1a, na.rm = TRUE)
      Score_Distress<- sum(Score_1b, na.rm = TRUE)
      Change<- 0
      Change_Distress<- 0
      if (input$RelChangeMethod == "Nunnally & Bernstein (1994)") {
      ...
      Cutoff_Score_Distress_1<- input$Cutoff_Distress_1
      Cutoff_Score_Distress_1<- round(Cutoff_Score_Distress_1, digits = 2)
      Cutoff_Score_Distress_2<- input$Cutoff_Distress_2
      Cutoff_Score_Distress_2<- round(Cutoff_Score_Distress_2, digits = 2)
      Cutoff_Score_Distress_3<- input$Cutoff_Distress_3
      Cutoff_Score_Distress_3<- round(Cutoff_Score_Distress_3, digits = 2)
      Entered_Scores_Df<<- data.frame(Date, Score, Change, PTS, SE, CI_Upper_Lim, CI_Lower_Lim, Cutoff_Score_1, Cutoff_Score_2,Cutoff_Score_3,Score_Distress,Change_Distress, Cutoff_Score_Distress_1,Cutoff_Score_Distress_2,Cutoff_Score_Distress_3
                                      )
      ...
      Score_2b<<-as.numeric(unlist(stri_split_fixed(input$Text_2_Distress,",", omit_empty = FALSE))) 
      Item_Df<<- data.frame(Item = 1:length(Score_2a), Score = Score_2a, Distress = Score_2b)
      Score_2<- sum(Score_2a, na.rm = TRUE)
      Score<- c(Score_1, Score_2)
      Score_Distress_1<- sum(Score_1b, na.rm = TRUE)
      Score_Distress_2<- sum(Score_2b, na.rm = TRUE)
      Score_Distress<- c(Score_Distress_1,Score_Distress_2)
      Change<- c(0, (Score_2 - Score_1))
      Change<- round(Change, digits = 2)
      Change_Distress<- c(0, (Score_Distress_2 - Score_Distress_1))
      Change_Distress<- round(Change_Distress, digits = 2)
      if (input$RelChangeMethod == "Nunnally & Bernstein (1994)") {
      ...
      Cutoff_Score_3<- round(Cutoff_Score_3, digits = 2)
      Cutoff_Score_Distress_1<- input$Cutoff_Distress_1
      Cutoff_Score_Distress_1<- c(Cutoff_Score_Distress_1,Cutoff_Score_Distress_1)
      Cutoff_Score_Distress_1<- round(Cutoff_Score_Distress_1, digits = 2)
      Cutoff_Score_Distress_2<- input$Cutoff_Distress_2
      Cutoff_Score_Distress_2<- c(Cutoff_Score_Distress_2,Cutoff_Score_Distress_2)
      Cutoff_Score_Distress_2<- round(Cutoff_Score_Distress_2, digits = 2)
      Cutoff_Score_Distress_3<- input$Cutoff_Distress_3
      Cutoff_Score_Distress_3<- c(Cutoff_Score_Distress_3,Cutoff_Score_Distress_3)
      Cutoff_Score_Distress_3<- round(Cutoff_Score_Distress_3, digits = 2)
      Entered_Scores_Df<<- data.frame(Date, Score, Change, PTS, SE, CI_Upper_Lim, CI_Lower_Lim, Cutoff_Score_1, Cutoff_Score_2,Cutoff_Score_3,Score_Distress,Change_Distress,Cutoff_Score_Distress_1,Cutoff_Score_Distress_2,Cutoff_Score_Distress_3
                                     )
      ...
      Score_3b<<-as.numeric(unlist(stri_split_fixed(input$Text_3_Distress,",", omit_empty = FALSE))) 
      Item_Df<<- data.frame(Item = 1:length(Score_3a), Score = Score_3a, Distress = Score_3b)
      Score_3<- sum(Score_3a, na.rm = TRUE)
      Score<- c(Score_1, Score_2, Score_3)
      Score_Distress_1<- sum(Score_1b, na.rm = TRUE)
      Score_Distress_2<- sum(Score_2b, na.rm = TRUE)
      Score_Distress_3<- sum(Score_3b, na.rm = TRUE)
      Score_Distress<- c(Score_Distress_1,Score_Distress_2,Score_Distress_3)
      Change<- c(0, (Score_2 - Score_1), (Score_3 - Score_2))
      Change<- round(Change, digits = 2)
      Change_Distress<- c(0, Score_Distress_2 - Score_Distress_1, Score_Distress_3 - Score_Distress_2)
      Change_Distress<- round(Change_Distress, digits = 2)
      if (input$RelChangeMethod == "Nunnally & Bernstein (1994)") {
        PTS_1<- (Rel * Score_1) + (M * (1 - Rel))
        PTS_2<- (Rel * Score_2) + (M * (1 - Rel))
      ...
      if(input$RelChangeMethod == "Crawford & Howell (1998)") {
        ...
        SE<- c(SE1, SE2, SE3)
        SE<- round(SE, digits = 2)
        SE_Distress<- round(SE_Distress, digits = 2)
      ...
      Cutoff_Score_3<- round(Cutoff_Score_3, digits = 2)
      Cutoff_Score_Distress_1<- input$Cutoff_Distress_1
      Cutoff_Score_Distress_1<- c(Cutoff_Score_Distress_1,Cutoff_Score_Distress_1,Cutoff_Score_Distress_1)
      Cutoff_Score_Distress_1<- round(Cutoff_Score_Distress_1, digits = 2)
      Cutoff_Score_Distress_2<- input$Cutoff_Distress_2
      Cutoff_Score_Distress_2<- c(Cutoff_Score_Distress_2,Cutoff_Score_Distress_2,Cutoff_Score_Distress_2)
      Cutoff_Score_Distress_2<- round(Cutoff_Score_Distress_2, digits = 2)
      Cutoff_Score_Distress_3<- input$Cutoff_Distress_3
      Cutoff_Score_Distress_3<- c(Cutoff_Score_Distress_3,Cutoff_Score_Distress_3,Cutoff_Score_Distress_3)
      Cutoff_Score_Distress_3<- round(Cutoff_Score_Distress_3, digits = 2)
      Entered_Scores_Df<<- data.frame(Date, Score, Change, PTS, SE, CI_Upper_Lim, CI_Lower_Lim, Cutoff_Score_1, Cutoff_Score_2,Cutoff_Score_3,Score_Distress,Change_Distress,Cutoff_Score_Distress_1,Cutoff_Score_Distress_2,Cutoff_Score_Distress_3
                                      )
    }
    ...
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] < Entered_Scores_Df$Score[1]) {
      PQB.Fullscale.Improvement<- "Yes"
    } else if (Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] >= Entered_Scores_Df$Score[1]) {
      PQB.Fullscale.Improvement<- "No"
    }
    
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] > Entered_Scores_Df$Score[1]) {
      PQB.Fullscale.Deterioration<- "Yes"
    } else if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] <= Entered_Scores_Df$Score[1]) {
      PQB.Fullscale.Deterioration<- "No"
    }
    
   
      
      if(Entered_Scores_Df$Score_Distress[length(Entered_Scores_Df$Score_Distress)] < Entered_Scores_Df$Score_Distress[1]) {
        PQB.Distress.Improvement<- "Yes"
      } else if (Entered_Scores_Df$Score_Distress[length(Entered_Scores_Df$Score_Distress)] >= Entered_Scores_Df$Score_Distress[1]) {
        PQB.Distress.Improvement<- "No"
      }
      
      if(Entered_Scores_Df$Score_Distress[length(Entered_Scores_Df$Score_Distress)] > Entered_Scores_Df$Score_Distress[1]) {
        PQB.Distress.Deterioration<- "Yes"
      } else if(Entered_Scores_Df$Score_Distress[length(Entered_Scores_Df$Score_Distress)] <= Entered_Scores_Df$Score_Distress[1]) {
        PQB.Distress.Deterioration<- "No"
      }
      

    PQB.Fullscale.Change<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] - Entered_Scores_Df$Score[1]
    PQB.Distress.Change<- Entered_Scores_Df$Score_Distress[length(Entered_Scores_Df$Score_Distress)] - Entered_Scores_Df$Score_Distress[1]
    PQB.Fullscale.Comparisons<- length(Entered_Scores_Df$Change) - 1
    PQB.Distress.Comparisons<- length(Entered_Scores_Df$Change_Distress) - 1
    PQB.Fullscale.First.Date<- Entered_Scores_Df$Date[1]
    PQB.Distress.First.Date<- Entered_Scores_Df$Date[1]
    PQB.Fullscale.Last.Date<- Entered_Scores_Df$Date[length(Entered_Scores_Df$Date)]
    PQB.Distress.Last.Date<- Entered_Scores_Df$Date[length(Entered_Scores_Df$Date)]
    PQB.Fullscale.First.Score<- Entered_Scores_Df$Score[1]
    PQB.Distress.First.Score<- Entered_Scores_Df$Score_Distress[1]
    PQB.Fullscale.Last.Score<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)]
    PQB.Distress.Last.Score<- Entered_Scores_Df$Score_Distress[length(Entered_Scores_Df$Score_Distress)]
   
    
    
    Analytics_Df<<- data.frame(PQB.Fullscale.First.Date, PQB.Fullscale.First.Score, PQB.Fullscale.Comparisons, PQB.Fullscale.Change, PQB.Fullscale.Last.Date, PQB.Fullscale.Last.Score, PQB.Fullscale.Improvement,PQB.Fullscale.Sig.Improvement, PQB.Fullscale.Deterioration, PQB.Fullscale.Sig.Deterioration,
                               PQB.Distress.First.Date, PQB.Distress.First.Score, PQB.Distress.Comparisons, PQB.Distress.Change, PQB.Distress.Last.Date, PQB.Distress.Last.Score, PQB.Distress.Improvement, PQB.Distress.Sig.Improvement, PQB.Distress.Deterioration, PQB.Distress.Sig.Deterioration
                               )
  ...
  Entered_Scores_Notifications<- observeEvent(input$Action_Submit_Data, {
    ...
    if(length(Score_1a) < 21) {
      showNotification("The PQ_B is a 21-item scale. You have entered less than 21 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(length(Score_1a) > 21) {
      showNotification("The PQ_B is a 21-item scale. You have entered more than 21 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(input$Timepoint != "1") {
      if(length(Score_2a) < 21) {
        showNotification("The PQ_B is a 21-item scale. You have entered less than 21 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_2a) > 21) {
        showNotification("The PQ_B is a 21-item scale. You have entered more than 21 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
    
    if(input$Timepoint == "3") {
      if(length(Score_3a) < 21) {
        showNotification("The PQ_B is a 21-item scale. You have entered less than 21 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_3a) > 21) {
        showNotification("The PQ_B is a 21-item scale. You have entered more than 21 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
  ...
  Combine_Data_Reac<- reactive({
    ...
    Gap_Distress<- Entered_Scores_Df[1,11] - Imported_Scores_CSV_ToCombine[nrow(Imported_Scores_CSV_ToCombine),11]
    Entered_Scores_Df[1,12]<- Gap_Distress
  ...
  output$report <- downloadHandler(
    ...
    filename = paste0(" PQ-B Report ", format(Sys.time(), '%d/%m/%y'),".pdf"),
  ...
  output$Download_Export_Data <- downloadHandler(
    ...
    filename = function() {
      paste(paste0(" PQ-B Data ", format(Sys.time(), '%d/%m/%y')), input$Output_Filetype1, sep = ".")
    },
