...
ui<- function(request) {
  sidebar <- dashboardSidebar(
    sidebarMenu(
      br(),
      menuItem(actionButton("Disclaimer", "Get Started", icon = icon("line-chart")), tabName = "SDS"),
  ...
  dashboardPage(
    dashboardHeader(title = span(tagList(tags$a(href = "http://psychlytx.com.au", "PsychlytX", style = "color: white; font-size: 26px; letter-spacing: 7.8px;font-weight: bolder;"), tags$sup("®"), "| Severity of Dependence Scale (SDS)"), style = "color: white; letter-spacing: 1.8px;"), titleWidth = 650),
    sidebar,
    dashboardBody(
                ...
                fluidRow(
                  tabBox(
                    ...
                    tabPanel("Scale",
                             wellPanel(
                             fluidRow(
                             column(width = 4, offset = 2, textInput("Drug_Name", h5(tags$strong("Drug name")), value = "alcohol", width = '400px')),
                             column(width = 4, textInput("Drug_Term", h5(tags$strong("Word to describe use (smoke/snort/hit/etc.)")), value = "drink", width = '400px'))
                                     )
                                      ),
                             uiOutput("SDS_Scale")
                            ),
                               ...
                               fluidRow(
                                 tabsetPanel(type = "pills",
                                             ...
                                             tabPanel("Population", width = 12,
                                                      ...
                                                      selectInput("Pop", "", choices = c("Alcohol Use", "Cannabis Use", "Cocaine Use", "Heroin Use", "Amphetamine Use", "Benzodiazepine Use", "Opiate Use", "Ketamine Use"))
                                             ),
                                             ...
                                             tabPanel("Reliable Change Method", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 4,
                                                               selectInput("Select_CI", label = "SDS total scale",
                                             ...
                                             tabPanel("Mean", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Chelune et al. (1993)' || input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)' || input.RelChangeMethod == 'Speer (1992)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Mean_1", "SDS total scale", value = 0)
                                             ...
                                             tabPanel("Sd", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Sd_1", "SDS total scale", value = 0)
                                                                         )))),
                                             ...
                                             tabPanel("Test-Retest Reliability", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 6,
                                                               numericInput("Reliability", "SDS total scale", value = .89),
                                                               h5("Reference: Gossop, Darke, Griffiths, Hando, Powis et al (1995)")
                                                        )),
                                             ...
                                             h4(tags$strong("Psychometric Properties of the SDS Relevant to Assessing Reliable & Clinically Significant Change")),
...
server <- function(input, output, session) {
  ...
  observe({
    ...
    Q_Scores <- paste(input$Item_1, input$Item_2, input$Item_3, input$Item_4, input$Item_5, sep = ",")
    Q_Date<- input$Q_Date
    Q_Name<- input$Q_Name
  ...
  CI_Vals_Reac<- reactive({
    ...
    if(input$Pop == "Alcohol Use") {
      Mean_Val<<- 3.6
      Sd_Val<<- 4.4
      Source_Mean<<- "Lawrinson, Copeland, Gerber & Gilmour (2000)"
      Source_Sd<<- "Lawrinson, Copeland, Gerber & Gilmour (2000)"
      Cut_Val_1<<- 3 
      Cut_Val_2<<- Mean_Val 
      Cut_Val_3<<- Mean_Val + Sd_Val
      Cut_Lab_1<<- "Alcohol Dependence Cut-Off (Lawrinson et al., 2000)"
      Cut_Lab_2<<- "Mean (Alcohol Use Sample)"
      Cut_Lab_3<<- "Mean + 1 Sd (Alcohol Use Sample)"
      Source_Cutoff_1<<- "Lawrinson, Copeland, Gerber & Gilmour (2000)"
      Source_Cutoff_2<<- "Lawrinson, Copeland, Gerber & Gilmour (2000)"
      Source_Cutoff_3<<- "Lawrinson, Copeland, Gerber & Gilmour (2000)"
    } else if(input$Pop == "Cannabis Use") {
      Mean_Val<<- 3.4
      Sd_Val<<-  3.7
      Source_Mean<<- "Martin, Copeland, Gates & Gilmour (2006)"
      Source_Sd<<- "Martin, Copeland, Gates & Gilmour (2006)"
      Cut_Val_1<<- 3
      Cut_Val_2<<- Mean_Val
      Cut_Val_3<<- 7
      Cut_Lab_1<<-  "Moderate Cannabis Dependence Cut-Off (Martin et al., 2006)"
      Cut_Lab_2<<-  "Mean (Cannabis Use Sample)"
      Cut_Lab_3<<-  "Severe Cannabis Dependence Cut-Off (Martin et al., 2006)"
      Source_Cutoff_1<<- "Cuenca-Royo, Sánchez-Niubó, Forero, Torrens, Suelves et al (2012)"
      Source_Cutoff_2<<- "Martin, Copeland, Gates & Gilmour (2006)"
      Source_Cutoff_3<<- "Cuenca-Royo, Sánchez-Niubó, Forero, Torrens, Suelves et al (2012)"
    } else if(input$Pop == "Heroin Use") {
      Mean_Val<<-  8.7
      Sd_Val<<-  4
      Source_Mean<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
      Source_Sd<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
      Cut_Val_1<<- 8.7
      Cut_Val_2<<-  Mean_Val + Sd_Val
      Cut_Val_3<<-  Mean_Val + (2*Sd_Val)
      Cut_Lab_1<<-  "Mean (Heroin Use Sample)"
      Cut_Lab_2<<-  "Mean + 1 Sd (Heroin Use Sample)"
      Cut_Lab_3<<-  "Mean + 2 Sd (Heroin Use Sample)"
      Source_Cutoff_1<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
      Source_Cutoff_2<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
      Source_Cutoff_3<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
    } 
    else if(input$Pop == "Cocaine Use") {
      Mean_Val<<- 4.2
        Sd_Val<<-  3.3
        Source_Mean<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
        Source_Sd<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
        ...
        Cut_Val_2<<-  Mean_Val
        Cut_Val_3<<-  Mean_Val + Sd_Val
        Cut_Lab_1<<-  "Cocaine Dependence Cut-Off (Kaye & Darke, 2002)"
        Cut_Lab_2<<-  "Mean (Cocaine Use Sample)"
        Cut_Lab_3<<-   "Mean + 1 Sd (Cocaine Use Sample)"
        Source_Cutoff_1<<- "Kaye & Darke (2002)"
        Source_Cutoff_2<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
        Source_Cutoff_3<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
    } 
    else if(input$Pop == "Amphetamine Use" ) {
      Mean_Val<<- 4.3
      Sd_Val<<- 3.2
      Source_Mean<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
      Source_Sd<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
      ...
      Cut_Val_2<<- 5
      Cut_Val_3<<- Mean_Val + Sd_Val
      Cut_Lab_1<<- "Mean (Amphetamine Use Sample)"
      Cut_Lab_2<<- "Amphetamine Dependence Cut-Off (Topp & Mattick, 1997)"
      Cut_Lab_3<<- "Mean + 1 Sd (Amphetamine Use Sample)" 
      Source_Cutoff_1<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
      Source_Cutoff_2<<- "Topp & Mattick (1997)"
      Source_Cutoff_3<<- "Gossop, Darke, Griffiths, Hando, Powis et al (1995)"
    } 
    else if(input$Pop == "Benzodiazepine Use") {
      Mean_Val<<- 6.4
        Sd_Val<<-  3.8
        Source_Mean<<- "de las Cuevas, Sanz, de la Fuente, Padilla & Berenguer (2000)" 
        Source_Sd<<- "de las Cuevas, Sanz, de la Fuente, Padilla & Berenguer (2000)"
        Cut_Val_1<<- Mean_Val
        Cut_Val_2<<- 7
        Cut_Val_3<<- Mean_Val + Sd_Val
        Cut_Lab_1<<- "Mean (Benzodiazepine Use Sample)"
        Cut_Lab_2<<- "Benzodiazepine Dependence Cut-Off (de Las Cuevas et al., 2000)"
        Cut_Lab_3<<- "Mean (Benzodiazepine Use Sample)"
        Source_Cutoff_1<<- "de las Cuevas, Sanz, de la Fuente, Padilla & Berenguer (2000)" 
        Source_Cutoff_2<<- "de las Cuevas, Sanz, de la Fuente, Padilla & Berenguer (2000)" 
        Source_Cutoff_3<<- "de las Cuevas, Sanz, de la Fuente, Padilla & Berenguer (2000)" 
    } 
    else if(input$Pop == "Opiate Use") {
      Mean_Val<<- 3.3
        Sd_Val<<-  3.2
        Source_Mean<<- "Castillo, Saiz, Rojas, Vázquez & Lerma (2010)"
        Source_Sd<<- "Castillo, Saiz, Rojas, Vázquez & Lerma (2010)"
        Cut_Val_1<<- Mean_Val
        Cut_Val_2<<- 5
        Cut_Val_3<<- Mean_Val + Sd_Val
        Cut_Lab_1<<- "Mean (Opiate Use Sample)"
        Cut_Lab_2<<- "Opiate Dependence Cut-Off (Castillo et al., 2010)"
        Cut_Lab_3<<- "Mean + 1 Sd (Opiate Use Sample)"   
        Source_Cutoff_1<<- "Castillo, Saiz, Rojas, Vázquez & Lerma (2010)"
        Source_Cutoff_2<<- "Castillo, Saiz, Rojas, Vázquez & Lerma (2010)"
        Source_Cutoff_3<<- "Castillo, Saiz, Rojas, Vázquez & Lerma (2010)"
    }
    else if(input$Pop == "Ketamine Use") {
        Mean_Val<<- 7.7
        Sd_Val<<-  3.8
        Source_Mean<<- "Tang, Morgan, Lau, Liang, Tang et al. (2015)" 
        Source_Sd<<- "Tang, Morgan, Lau, Liang, Tang et al. (2015)"
        Cut_Val_1<<- 4
        Cut_Val_2<<- Mean_Val
        Cut_Val_3<<- Mean_Val + Sd_Val
        Cut_Lab_1<<- "Ketamine Dependence Cut-Off (Fernández-Calderón et al., 2016)"
        Cut_Lab_2<<- "Mean (Ketamine Use Sample)" 
        Cut_Lab_3<<- "Mean + 1 Sd (Ketamine Use Sample)"    
        Source_Cutoff_1<<- "Fernández-Calderón, Vidal-Giné, López-Guerrero, Lozano-Rojas (2016)"
        Source_Cutoff_2<<- "Tang, Morgan, Lau, Liang, Tang et al. (2015)"
        Source_Cutoff_3<<- "Tang, Morgan, Lau, Liang, Tang et al. (2015)"
    }
  })
  ...
  output$Mean_Widg<- renderUI({
    ...
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Mean_1", "SDS total scale", Mean_Val),
  ...
  output$Sd_Widg<- renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Sd_1", "SDS total scale", Sd_Val),
  ...
  output$Cutoff_Widg_1<- renderUI({ 
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_1", "SDS total scale", as.numeric(Cut_Val_1)),
  ...
  output$Cutoff_Widg_2<-  renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_2", "SDS total scale", as.numeric(Cut_Val_2)),
  ...
  output$Cutoff_Widg_3<-renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_3", "SDS total scale", as.numeric(Cut_Val_3)),
  ...
  Entered_Scores_Reac<- reactive({
    ...
    if(input$Timepoint == "1") {
      ...
      Item_Df<<- data.frame(Item = 1:5, Score = Score_1a)
      ...
      Item_Df<<- data.frame(Item = 1:5, Score = Score_2a)
      ...
      Item_Df<<- data.frame(Item = 1:5, Score = Score_3a)
    ...
    if (input$Select_CI == '2') {
      ...
      Stats_Table_Fullscale<<- Stats_Table_Fullscale %>% as_tibble() %>% mutate("Refence Population" = NULL, M = NULL, Sd = NULL, Confidence = NULL, Reliability = NULL,
    ...
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] < Entered_Scores_Df$Score[1]) {
      SDS.Fullscale.Improvement<- "Yes"
    } else if (Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] >= Entered_Scores_Df$Score[1]) {
      SDS.Fullscale.Improvement<- "No"
    }
    
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] > Entered_Scores_Df$Score[1]) {
      SDS.Fullscale.Deterioration<- "Yes"
    } else if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] <= Entered_Scores_Df$Score[1]) {
      SDS.Fullscale.Deterioration<- "No"
    }
    
    
    
    SDS.Fullscale.Change<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] - Entered_Scores_Df$Score[1]
    SDS.Fullscale.Comparisons<- length(Entered_Scores_Df$Change) - 1
    SDS.Fullscale.First.Date<- Entered_Scores_Df$Date[1]
    SDS.Fullscale.Last.Date<- Entered_Scores_Df$Date[length(Entered_Scores_Df$Date)]
    SDS.Fullscale.First.Score<- Entered_Scores_Df$Score[1]
    SDS.Fullscale.Last.Score<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)]
    
    
    Analytics_Df<<- data.frame(SDS.Fullscale.First.Date, SDS.Fullscale.First.Score, SDS.Fullscale.Comparisons, SDS.Fullscale.Change, SDS.Fullscale.Last.Date, SDS.Fullscale.Last.Score, SDS.Fullscale.Improvement,SDS.Fullscale.Sig.Improvement, SDS.Fullscale.Deterioration, SDS.Fullscale.Sig.Deterioration)
  ...
  Entered_Scores_Notifications<- observeEvent(input$Action_Submit_Data, {
    ...
    if(length(Score_1a) < 5) {
      showNotification("The SDS is a 5-item scale. You have entered less than 5 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(length(Score_1a) > 5) {
      showNotification("The SDS is a 5-item scale. You have entered more than 5 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(input$Timepoint != "1") {
      if(length(Score_2a) < 5) {
        showNotification("The SDS is a 5-item scale. You have entered less than 5 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_2a) > 5) {
        showNotification("The SDS is a 5-item scale. You have entered more than 5 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
    
    if(input$Timepoint == "3") {
      if(length(Score_3a) < 5) {
        showNotification("The SDS is a 5-item scale. You have entered less than 5 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_3a) > 5) {
        showNotification("The SDS is a 5-item scale. You have entered more than 5 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
  ...
  output$report <- downloadHandler(
    ...
    filename = paste0(" SDS Report ", format(Sys.time(), '%d/%m/%y'),".pdf"),
  ...
  output$Download_Export_Data <- downloadHandler(
    ...
    filename = function() {
      paste(paste0(" SDS Data ", format(Sys.time(), '%d/%m/%y')), input$Output_Filetype1, sep = ".")
    },
