...
ui<- function(request) {
  sidebar <- dashboardSidebar(
    sidebarMenu(
      br(),
      menuItem(actionButton("Disclaimer", "Get Started", icon = icon("line-chart")), tabName = "SIAS"),
  ...
  dashboardPage(
    dashboardHeader(title = span(tagList(tags$a(href = "http://psychlytx.com.au", "PsychlytX", style = "color: white; font-size: 26px; letter-spacing: 7.8px;font-weight: bolder;"), tags$sup("®"), "| Social Interaction Anxiety Scale (SIAS)"), style = "color: white; letter-spacing: 1.8px;"), titleWidth = 680),
    sidebar,
    dashboardBody(
      ...
      tabItems(
        ...
        tabItem(tabName = "References", br(), 
                ...
                "Mörtberg, E., Reuterskiöld, L., Tillfors, M., Furmark, T., & Öst, L. (2017). Factor solutions of the social phobia scale (SPS) and the social interaction anxiety scale (SIAS) in a swedish population. Cognitive Behaviour Therapy, 46(4), 300-314."
                               ...
                               fluidRow(
                                 tabsetPanel(type = "pills",
                                             ...
                                             tabPanel("Reliable Change Method", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 4,
                                                               selectInput("Select_CI", label = "SIAS total scale",
                                             ...
                                             tabPanel("Mean", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Chelune et al. (1993)' || input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)' || input.RelChangeMethod == 'Speer (1992)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Mean_1", "SIAS total scale", value = 0)
                                             ...
                                             tabPanel("Sd", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Sd_1", "SIAS total scale", value = 0)
                                                                         )))),
                                             ...
                                             tabPanel("Test-Retest Reliability", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 6,
                                                               numericInput("Reliability", "SIAS total scale", value = .96),
                                             ...
                                             h4(tags$strong("Psychometric Properties of the SIAS Relevant to Assessing Reliable & Clinically Significant Change")),
...
server <- function(input, output, session) {
  ...
  CI_Vals_Reac<- reactive({
    ...
    if(input$Pop == "Social Anxiety Disorder (Social Phobia)") {
      ...
      Cut_Lab_2<<-  "Community Sample Mean + 1Sd"
      Cut_Lab_3<<-  "Social Phobia Cut-Off: Heimberg et al. (1992)"
      Source_Cutoff_1<<- "Mattick & Clarke (1998)"
      Source_Cutoff_2<<- "Mattick & Clarke (1998)"
      Source_Cutoff_3<<- "Heimberg et al.(1992)"
      ...
      Cut_Lab_2<<-  "University Student Mean + 1Sd"
      Cut_Lab_3<<-  "Social Phobia Cut-Off: Heimberg et al.(1992)"
      Source_Cutoff_1<<- "Boyers, Broman-Fulks, Valentiner, McCraw, Curtin & Michael (2017)"
      Source_Cutoff_2<<- "Boyers, Broman-Fulks, Valentiner, McCraw, Curtin & Michael (2017)"
      Source_Cutoff_3<<- "Heimberg et al.(1992)"
    } 
  ...
  output$Mean_Widg<- renderUI({
    ...
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Mean_1", "SIAS total scale", Mean_Val),
  ...
  output$Sd_Widg<- renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Sd_1", "SIAS total scale", Sd_Val),
  ...
  output$Cutoff_Widg_1<- renderUI({ 
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_1", "SIAS total scale", as.numeric(Cut_Val_1)),
  ...
  output$Cutoff_Widg_2<-  renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_2", "SIAS total scale", as.numeric(Cut_Val_2)),
  ...
  output$Cutoff_Widg_3<-renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_3", "SIAS total scale", as.numeric(Cut_Val_3)),
  ...
  Entered_Scores_Reac<- reactive({
    ...
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] < Entered_Scores_Df$Score[1]) {
      SIAS.Fullscale.Improvement<- "Yes"
    } else if (Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] >= Entered_Scores_Df$Score[1]) {
      SIAS.Fullscale.Improvement<- "No"
    }
    
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] > Entered_Scores_Df$Score[1]) {
      SIAS.Fullscale.Deterioration<- "Yes"
    } else if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] <= Entered_Scores_Df$Score[1]) {
      SIAS.Fullscale.Deterioration<- "No"
    }
    
    
    
    SIAS.Fullscale.Change<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] - Entered_Scores_Df$Score[1]
    SIAS.Fullscale.Comparisons<- length(Entered_Scores_Df$Change) - 1
    SIAS.Fullscale.First.Date<- Entered_Scores_Df$Date[1]
    SIAS.Fullscale.Last.Date<- Entered_Scores_Df$Date[length(Entered_Scores_Df$Date)]
    SIAS.Fullscale.First.Score<- Entered_Scores_Df$Score[1]
    SIAS.Fullscale.Last.Score<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)]
    
    
    Analytics_Df<<- data.frame(SIAS.Fullscale.First.Date, SIAS.Fullscale.First.Score, SIAS.Fullscale.Comparisons, SIAS.Fullscale.Change, SIAS.Fullscale.Last.Date, SIAS.Fullscale.Last.Score, SIAS.Fullscale.Improvement,SIAS.Fullscale.Sig.Improvement, SIAS.Fullscale.Deterioration, SIAS.Fullscale.Sig.Deterioration)
  ...
  Entered_Scores_Notifications<- observeEvent(input$Action_Submit_Data, {
    ...
    if(length(Score_1a) < 20) {
      showNotification("The SIAS is a 20-item scale. You have entered less than 20 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(length(Score_1a) > 20) {
      showNotification("The SIAS is a 20-item scale. You have entered more than 20 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(input$Timepoint != "1") {
      if(length(Score_2a) < 20) {
        showNotification("The SIAS is a 20-item scale. You have entered less than 20 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_2a) > 20) {
        showNotification("The SIAS is a 20-item scale. You have entered more than 20 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
    
    if(input$Timepoint == "3") {
      if(length(Score_3a) < 20) {
        showNotification("The SIAS is a 20-item scale. You have entered less than 20 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_3a) > 20) {
        showNotification("The SIAS is a 20-item scale. You have entered more than 20 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
  ...
  output$report <- downloadHandler(
    ...
    filename = paste0(" SIAS Report ", format(Sys.time(), '%d/%m/%y'),".pdf"),
  ...
  output$Download_Export_Data <- downloadHandler(
    ...
    filename = function() {
      paste(paste0(" SIAS Data ", format(Sys.time(), '%d/%m/%y')), input$Output_Filetype1, sep = ".")
    },
