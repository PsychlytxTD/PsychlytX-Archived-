...
ui<- function(request) {
  sidebar <- dashboardSidebar(
    sidebarMenu(
      br(),
      menuItem(actionButton("Disclaimer", "Get Started", icon = icon("line-chart")), tabName = "SSD12"),
  ...
  dashboardPage(
    dashboardHeader(title = span(tagList(tags$a(href = "http://psychlytx.com.au", "PsychlytX", style = "color: white; font-size: 26px; letter-spacing: 7.8px;font-weight: bolder;"), tags$sup("®"), "| Somatic Symptom Disorder - B Criteria Scale (SSD-12)"), style = "color: white; letter-spacing: 1.8px;"), titleWidth = 830),
    sidebar,
    dashboardBody(
      ...
      tabItems(
        ...
        tabItem(tabName = "References", br(), 
                ...
                "Barsky, A. J. (2015). Assessing the New DSM-5 Diagnosis of Somatic Symptom Disorder. Psychosomatic Medicine, 78, 2-4.", br(), br(),
                "Toussaint, A., Löwe, B, Bräler, E., & Jordan, P. (2017). The Somatic Symptom Disorder - B Criteria Scale (SSD-12): Factorial structure, validity and population-based norms. Journal of Psychosomatic Research, 97, 9-17.", br(), br(),
                "Toussaint, A., Murray, A. M., Voigt, K., Herzog, A., et al. (2016). Development and Validation of the Somatic Symptom Disorder–B Criteria Scale (SSD-12). Psychosomatic Medicine, 78, 5-12.", br(), br(),
                "Toussaint, A., Riedl, B., Kehrer, S., Schneider, A., Löwe, B., & Linde, K. (2017). Validity of the Somatic Symptom Disorder–B Criteria Scale (SSD-12) in primary care. Family Practice, 1-6."
      
        ),
        
        
        
        tabItem(tabName = "SSD12",
                fluidRow(
                  tabBox(
                    id = "Box",
                    width = 12,
                    tabPanel("Scale",
                             wellPanel(style = "background-color: #ffffff; color: black",
                                       ...
                                       fluidRow(
                                         column(width = 12, h5("Scale Source: Toussaint A, Murray AM, Voigt K et al. (2016). Development and validation of the Somatic Symptom Disorder–B Criteria Scale (SSD-12). Psychosomatic Medicine, 78, 5–12."))
                                       )
                             )),
                    tabPanel("Enter Data",
                             fluidRow(
                             ...
                             fluidRow(
                               column(4,
                                      ...
                                      helpText(tags$em("*Your patient's name cannot be seen or used by Sentient Psychometrics. If provided, it will appear in the patient report and analytics spreadsheet (if created), accessible only to you.
                               ...
                               fluidRow(
                                 tabsetPanel(type = "pills",
                                             ...
                                             tabPanel("Population", width = 12,
                                                      ...
                                                      selectInput("Pop", "", choices = c("Males: General Population (14-24 yrs)", "Females: General Population (14-24 yrs)", 
                                                                                         "Males: General Population (25-34 yrs)",  "Females: General Population (25-34 yrs)",
                                                                                         "Males: General Population (35-44 yrs)",  "Females: General Population (35-44 yrs)",
                                                                                         "Males: General Population (45-54 yrs)",  "Females: General Population (45-54 yrs)",
                                                                                         "Males: General Population (55-64 yrs)",  "Females: General Population (55-64 yrs)",
                                                                                         "Males: General Population (65-74 yrs)",  "Females: General Population (65-74 yrs)",
                                                                                         "Males: General Population (74 > yrs)",  "Females: General Population (74 > yrs)",
                                                                                         "Psychosomatic Outpatient Clinic", "Primary Care"))
                                             ),
                                             ...
                                             tabPanel("Reliable Change Method", width = 12,
                                                      ...
                                                      h5("*When selecting a method other than Nunnally & Bernstein (1994) or Jacobson & Truax (1991), you must enter a value for the retest mean.
                                                                 ...
                                                                 visit the", tags$a(href = "www.sentientpsychometrics.com.au", "Sentient Psychometrics website.")),
                                                      ...
                                                      fluidRow(
                                                        column(width = 4,
                                                               selectInput("Select_CI", label = "SSD-12 total scale",
                                             ...
                                             tabPanel("Mean", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Chelune et al. (1993)' || input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)' || input.RelChangeMethod == 'Speer (1992)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Mean_1", "SSD12 total scale", value = 0)
                                             ...
                                             tabPanel("Sd", width = 12,
                                                      ...
                                                      conditionalPanel(condition = "input.RelChangeMethod == 'Crawford & Howell (1998)'|| input.RelChangeMethod == 'Maassen et al. (2006)' || input.RelChangeMethod == 'McSweeny et al. (1993)'",
                                                                       ...
                                                                       fluidRow(
                                                                         column(width = 4,
                                                                                numericInput("Retest_Sd_1", "SSD-12 total scale", value = 0)
                                                                         )))),
                                             ...
                                             tabPanel("Test-Retest Reliability", width = 12,
                                                      ...
                                                      fluidRow(
                                                        column(width = 6,
                                                               numericInput("Reliability", "SSD-12 total scale", value = .95),
                                                               h5("Reference: Toussaint, Löwe, Brähler & Jordan (2017)"),
                                                               h6(tags$em("*Value is internal consistency (Cronbach's alpha), not test-retest reliability."))
                                                        )),
                                             ...
                                             h4(tags$strong("Psychometric Properties of the SSD12 Relevant to Assessing Reliable & Clinically Significant Change")),
                  ...
                  column(span(tagList(icon("copyright", lib = "font-awesome")), "Timothy Deitz 2018 | Sentient Psychometrics") , offset = 4, width = 12)
                )))))
...
server <- function(input, output, session) {
  ...
  observeEvent(input$Disclaimer, {
    showModal(modalDialog(
      ...
      "1. Sentient Psychometrics will not view, use or retain any patient data entered into this program.", br(),
      "2. This program is subject to copyright and will not be used without the permission of Sentient Psychometrics.", br(),
      "3. Sentient Psychometrics assumes no responsibility for the inappropriate use or disclosure of patient information.", br(),
      ...
      "5. Sentient Psychometrics does not encourage or condone the use of psychological scales where such use does not meet the correct conditions of consent, licensing and payment, as outlined by the scale developer(s)."
    ))
  })
  ...
  CI_Vals_Reac<- reactive({
    ...
    if(input$Pop == "Males: General Population (14-24 yrs)") {
      Mean_Val<<- 3
      Sd_Val<<- 9.3
      Source_Mean<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Sd<<- "Toussaint, Löwe, Brähler & Jordan (2017): *Value is the Sd for the entire sample with all age groups included."
        Cut_Val_1<<- 2
        Cut_Val_2<<- 10
        Cut_Val_3<<- 13
        Cut_Lab_1<<- "70th Percentile"
        Cut_Lab_2<<- "90th Percentile"
        Cut_Lab_3<<- "95th Percentile"
        Source_Cutoff_1<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
        Source_Cutoff_2<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
        Source_Cutoff_3<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
    } else if(input$Pop == "Females: General Population (14-24 yrs)") {
      Mean_Val<<- 5
      Sd_Val<<- 9.3
      Source_Mean<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Sd<<- "Toussaint, Löwe, Brähler & Jordan (2017): *Value is the Sd for the entire sample with all age groups included."
      Cut_Val_1<<- 2
        Cut_Val_2<<-9  
        Cut_Val_3<<- 20
        Cut_Lab_1<<- "52nd Percentile"
        Cut_Lab_2<<- "80th Percentile"
        Cut_Lab_3<<- "95th Percentile"
        Source_Cutoff_1<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Cutoff_2<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Cutoff_3<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      ...
      Cut_Val_1<<- 3
        Cut_Val_2<<-12   
        Cut_Val_3<<- 20
        Cut_Lab_1<<- "54th Percentile"
        Cut_Lab_2<<- "82nd Percentile"
        Cut_Lab_3<<- "94th Percentile"
      Source_Cutoff_1<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Cutoff_2<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Cutoff_3<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      ...
      Cut_Val_1<<- 1
        Cut_Val_2<<- 9
        Cut_Val_3<<- 22
        Cut_Lab_1<<- "58th Percentile"
        Cut_Lab_2<<- "81st Percentile"
        Cut_Lab_3<<- "95th Percentile"
        Source_Cutoff_1<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Cutoff_2<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Cutoff_3<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      ...
      Source_Cutoff_2<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Cutoff_3<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
    } else if(input$Pop == "Males: General Population (74 > yrs)") {
      Mean_Val<<- 12
      Sd_Val<<- 9.3
      Source_Mean<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Sd<<- "Toussaint, Löwe, Brähler & Jordan (2017): *Value is the Sd for the entire sample with all age groups included."
      Cut_Val_1<<- 11
        Cut_Val_2<<- 80
        Cut_Val_3<<- 27
        Cut_Lab_1<<- "49th Percentile"
        Cut_Lab_2<<- "80th Percentile"
        Cut_Lab_3<<- "94th Percentile"
        Source_Cutoff_1<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Cutoff_2<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Cutoff_3<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
    } else if(input$Pop == "Females: General Population (74 > yrs)") {
      Mean_Val<<- 15.5
      Sd_Val<<- 9.3
      Source_Mean<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Sd<<- "Toussaint, Löwe, Brähler & Jordan (2017): *Value is the Sd for the entire sample with all age groups included."
      Cut_Val_1<<- 15
        ...
        Cut_Val_3<<- 35
        Cut_Lab_1<<- "51st Percentile"
        Cut_Lab_2<<- "83rd Percentile"
        Cut_Lab_3<<- "94th Percentile"
        Source_Cutoff_1<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Cutoff_2<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
      Source_Cutoff_3<<- "Toussaint, Löwe, Brähler & Jordan (2017)"
    } else if(input$Pop == "Psychosomatic Outpatient Clinic") {
      Mean_Val<<- 20.4
      Sd_Val<<- 12.7
      Source_Mean<<- "Toussaint, Murray, Voigt, Herzog, Gierk et al (2016)"
      Source_Sd<<- "Toussaint, Murray, Voigt, Herzog, Gierk et al (2016)"
      Cut_Val_1<<- Mean_Val
        ...
        Cut_Lab_2<<- "Mean + 1 Sd"
        Cut_Lab_3<<- "Mean + 2 Sd"
        Source_Cutoff_1<<- "Toussaint, Murray, Voigt, Herzog, Gierk et al (2016)"
      Source_Cutoff_2<<- "Toussaint, Murray, Voigt, Herzog, Gierk et al (2016)"
      Source_Cutoff_3<<- "Toussaint, Murray, Voigt, Herzog, Gierk et al (2016)"
    } else if(input$Pop == "Primary Care") {
      Mean_Val<<- 11.43
        Sd_Val<<- 8.97
        Source_Mean<<- "Toussaint, Riedl, Kehrer, Schneider, Löwe et al (2017)"
      Source_Sd<<- "Toussaint, Murray, Voigt, Herzog, Gierk et al (2016)"
      Cut_Val_1<<- Mean_Val
        Cut_Val_2<<- Mean_Val + Sd_Val
        Cut_Val_3<<- Mean_Val + (2*Sd_Val)
        ...
        Cut_Lab_2<<- "Mean + 1 Sd"
        Cut_Lab_3<<- "Mean + 2 Sd"
        Source_Cutoff_1<<- "Toussaint, Riedl, Kehrer, Schneider, Löwe et al (2017)"
      Source_Cutoff_2<<- "Toussaint, Riedl, Kehrer, Schneider, Löwe et al (2017)"
      Source_Cutoff_3<<- "Toussaint, Riedl, Kehrer, Schneider, Löwe et al (2017)"
    }                                                                                                          
  ...
  output$Mean_Widg<- renderUI({
    ...
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Mean_1", "SSD-12 total scale", Mean_Val),
  ...
  output$Sd_Widg<- renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Pop_Sd_1", "SSD-12 total scale", Sd_Val),
  ...
  output$Cutoff_Widg_1<- renderUI({ 
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_1", "SSD-12 total scale", as.numeric(Cut_Val_1)),
  ...
  output$Cutoff_Widg_2<-  renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_2", "SSD-12 total scale", as.numeric(Cut_Val_2)),
  ...
  output$Cutoff_Widg_3<-renderUI({
    CI_Vals_Reac()
    tagList(
      numericInput("Cutoff_3", "SSD-12 total scale", as.numeric(Cut_Val_3)),
  ...
  Entered_Scores_Reac<- reactive({
    ...
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] < Entered_Scores_Df$Score[1]) {
      SSD12.Fullscale.Improvement<- "Yes"
    } else if (Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] >= Entered_Scores_Df$Score[1]) {
      SSD12.Fullscale.Improvement<- "No"
    }
    
    if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] > Entered_Scores_Df$Score[1]) {
      SSD12.Fullscale.Deterioration<- "Yes"
    } else if(Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] <= Entered_Scores_Df$Score[1]) {
      SSD12.Fullscale.Deterioration<- "No"
    }
    
    
    
    SSD12.Fullscale.Change<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)] - Entered_Scores_Df$Score[1]
    SSD12.Fullscale.Comparisons<- length(Entered_Scores_Df$Change) - 1
    SSD12.Fullscale.First.Date<- Entered_Scores_Df$Date[1]
    SSD12.Fullscale.Last.Date<- Entered_Scores_Df$Date[length(Entered_Scores_Df$Date)]
    SSD12.Fullscale.First.Score<- Entered_Scores_Df$Score[1]
    SSD12.Fullscale.Last.Score<- Entered_Scores_Df$Score[length(Entered_Scores_Df$Score)]
    
    
    Analytics_Df<<- data.frame(SSD12.Fullscale.First.Date, SSD12.Fullscale.First.Score, SSD12.Fullscale.Comparisons, SSD12.Fullscale.Change, SSD12.Fullscale.Last.Date, SSD12.Fullscale.Last.Score, SSD12.Fullscale.Improvement,SSD12.Fullscale.Sig.Improvement, SSD12.Fullscale.Deterioration, SSD12.Fullscale.Sig.Deterioration)
  ...
  Entered_Scores_Notifications<- observeEvent(input$Action_Submit_Data, {
    ...
    if(length(Score_1a) < 12) {
      showNotification("The SSD12 is a 12-item scale. You have entered less than 12 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(length(Score_1a) > 12) {
      showNotification("The SSD12 is a 12-item scale. You have entered more than 12 scores for the first timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
    }
    
    if(input$Timepoint != "1") {
      if(length(Score_2a) < 12) {
        showNotification("The SSD12 is a 12-item scale. You have entered less than 12 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_2a) > 12) {
        showNotification("The SSD12 is a 12-item scale. You have entered more than 12 scores for the second timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
    
    if(input$Timepoint == "3") {
      if(length(Score_3a) < 12) {
        showNotification("The SSD12 is a 12-item scale. You have entered less than 12 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      } else if(length(Score_3a) > 12) {
        showNotification("The SSD12 is a 12-item scale. You have entered more than 12 scores for the third timepoint. Enter the correct number of scores and then reclick the 'Submit Newly-Entered Data' button. Alternatively, proceed despite the missing data.", type = "error", duration = NULL)
      }
    }
  ...
  output$report <- downloadHandler(
    ...
    filename = paste0(" SSD-12 Report ", format(Sys.time(), '%d/%m/%y'),".pdf"),
  ...
  output$Download_Export_Data <- downloadHandler(
    ...
    filename = function() {
      paste(paste0(" SSD-12 Data ", format(Sys.time(), '%d/%m/%y')), input$Output_Filetype1, sep = ".")
    },
